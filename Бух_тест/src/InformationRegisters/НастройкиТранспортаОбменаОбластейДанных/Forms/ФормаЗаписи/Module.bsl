...
Процедура ПроверитьПодключение(ВидТранспортаСтрокой)
	...
	ТекстПредупреждения = ?(Отказ, НСтр("ru='Не удалось установить подключение.';uk='Не вдалося встановити підключення.'"), НСтр("ru='Подключение успешно установлено.';uk='Підключення успішно встановлене.'"));
