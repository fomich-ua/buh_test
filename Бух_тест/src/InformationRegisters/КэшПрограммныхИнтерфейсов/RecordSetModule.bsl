...
"интерфейсов в дополнительном свойстве набора записей ПараметрыПолучения!';uk='При записі даних у регістр відомостей КэшПрограммныхИнтерфейсов із сеансів "
"с включеним поділом потрібно передавати параметри одержання даних для кешу"
"інтерфейсів у додатковій властивості набору записів ПараметрыПолучения!'");
...
"внутри транзакции записи из сеанса с включенным разделением!';uk='Неприпустима зміна ресурсу Дані записи регістра відомостей КэшПрограммныхИнтерфейсов"
