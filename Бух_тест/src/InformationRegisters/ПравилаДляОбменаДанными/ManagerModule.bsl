...
"CorrespondentExchangeRules.xml - правила конвертации для программы-корреспондента.';uk='Імена файлів в архіві не відповідають очікуваним. Очікуються файли:"
...
"ExchangeRules.xml - правила конвертации для текущей программы;"
"CorrespondentExchangeRules.xml - правила конвертации для программы-корреспондента.';uk='В архіві знайдений один файл правил конвертації. Очікувана кількість файлів в архіві - два. Очікуються файли:"
"ExchangeRules.xml - правила конвертації для поточної програми;"
"CorrespondentExchangeRules.xml - правила конвертації для програми-кореспондента.'");
					ОбменДаннымиСервер.СообщитьОбОшибке(НСтрока, Отказ);
	...
	Если Не Отказ Тогда
		...
		Если ЭтоПравилаКонвертации Тогда
			...
			Если РежимСовместимости <> РежимСовместимостиКорреспондента Тогда
				ВызватьИсключение Нстр("ru='Резличаются режимы совместимости правил обмена текущей конфигурации и конфигурации-корреспондента.';uk='Розрізняються режими сумісності правил обміну поточної конфігурації й кореспондент-кореспондента-конфігурації-кореспондента.'");
			Иначе
...
"RegistrationRules.xml - правила регистрации для текущей программы.';uk='Не вірний формат комплекту правил. Очікувана кількість файлів в архіві - три. Очікуються файли:"
"ExchangeRules.xml - правила конвертації для поточної програми;"
"CorrespondentExchangeRules.xml - правила конвертації для програми-кореспондента;"
...
"ExchangeRules.xml - правила конвертации для текущей программы;"
"CorrespondentExchangeRules.xml - правила конвертации для программы-корреспондента;"
"RegistrationRules.xml - правила регистрации для текущей программы.';uk='Імена файлів в архіві не відповідають очікуваним. Очікуються файли:"
"ExchangeRules.xml - правила конвертації для поточної програми;"
"CorrespondentExchangeRules.xml - правила конвертації для програми-кореспондента;"
"RegistrationRules.xml - правила реєстрації для поточної програми.'");
					ОбменДаннымиСервер.СообщитьОбОшибке(НСтрока, Отказ);
...
"Возможно выбран не тот файл, либо XML-файл имеет некорректную структуру. Выберите корректный файл.';uk='Не вдалося визначити вид правил через помилку в розбору Xml-Файлу [ИмяФайла]. "
"Можливо обраний не той файл, або Xml-Файл має некоректну структуру. Виберіть коректний файл.'");
...
"Возможно выбран не тот файл, либо XML-файл имеет некорректную структуру. Выберите корректный файл.';uk='Не вдалося визначити вид правил через помилку у форматі правил Xml-Файлу [ИмяФайла]."
"Можливо обраний не той файл, або Xml-Файл має некоректну структуру. Виберіть коректний файл.'");
			НСтрока = СтроковыеФункцииКлиентСервер.ВставитьПараметрыВСтроку(НСтрока, Новый Структура("ИмяФайла", ИмяФайла));
			ОбменДаннымиСервер.СообщитьОбОшибке(НСтрока, Отказ);
