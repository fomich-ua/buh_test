...
"выполнения анализа всей цепочки изменений этих объектов. Продолжить?';uk=""Вилучення записів по версіях об'єктів може привести до неможливості "
"виконання аналізу всього ланцюжка змін цих об'єктів. Продовжити?""");
