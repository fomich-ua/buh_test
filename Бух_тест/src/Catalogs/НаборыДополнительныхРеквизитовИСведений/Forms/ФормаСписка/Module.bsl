...
Процедура НастроитьОтображениеНаборов()
	...
	Если ЭтоНаборыДополнительныхСведений Тогда
		...
		КомандаСоздать.Подсказка          = НСтр("ru='Создать уникальное сведение';uk='Створити унікальна відомість'");
		КомандаСоздатьПоОбразцу.Заголовок = НСтр("ru='По образцу...';uk='За зразком...'");
		КомандаСоздатьПоОбразцу.Подсказка = НСтр("ru='Создать сведение по образцу (общий список значений)';uk='Створити відомість за зразком (загальний список значень)'");
		КомандаСоздатьОбщее.Заголовок     = НСтр("ru='Общее...';uk='Загальне...'");
		КомандаСоздатьОбщее.Подсказка     = НСтр("ru='Выбрать общее сведение из существующих';uk='Вибрати загальна відомість із існуючих'");
...
"нескольких наборах дополнительных сведений.';uk='Загальна додаткова відомість, що використовується в"
"декількох наборах додаткових відомостей.'");
	Иначе
		...
		КомандаСоздатьПоОбразцу.Заголовок = НСтр("ru='По образцу...';uk='За зразком...'");
		КомандаСоздатьПоОбразцу.Подсказка = НСтр("ru='Создать реквизит по образцу (общий список значений)';uk='Створити реквізит за зразком (загальний список значень)'");
		КомандаСоздатьОбщее.Заголовок     = НСтр("ru='Общий...';uk='Загальний...'");
		КомандаСоздатьОбщее.Подсказка     = НСтр("ru='Выбрать общий реквизит из существующих';uk='Вибрати загальний реквізит з існуючих'");
...
"нескольких наборах дополнительных реквизитов.';uk='Загальний додатковий реквізит, що використовується в"
...
""
"Повторите действие, если требуется.';uk='Дія не виконана, тому що склад додаткових відомостей"
...
""
"Повторите действие, если требуется.';uk='Дія не виконана, тому що склад додаткових реквізитів"
"був змінений іншим користувачем."
