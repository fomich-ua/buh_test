...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.РежимВыбора Тогда
		...
		Если Параметры.ЗакрыватьПриВыборе = Ложь Тогда
			...
			Если ХранимыеПараметры.РасширенныйПодбор Тогда
				ЭтотОбъект.КлючСохраненияПоложенияОкна = "РасширенныйПодборПользователей";
				ИзменитьПараметрыРасширеннойФормыПодбора();
			Иначе
				ЭтотОбъект.КлючСохраненияПоложенияОкна = "РежимПодбораПользователей";
			КонецЕсли;
	...
	ОбщегоНазначенияКлиентСервер.ПеренестиОтборыВДинамическийСписок(ЭтотОбъект, ПользователиСписок);
КонецПроцедуры
