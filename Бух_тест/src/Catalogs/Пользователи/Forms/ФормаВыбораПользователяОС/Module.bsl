...
Процедура Выбрать(Команда)
	...
	Если Элементы.ТаблицаДоменов.ТекущиеДанные = Неопределено Тогда
		ПоказатьПредупреждение(, НСтр("ru='Выберите домен.';uk='Виберіть домен.'"));
		Возврат;
	КонецЕсли;
	...
	Если Элементы.ТаблицаПользователейДомена.ТекущиеДанные = Неопределено Тогда
		ПоказатьПредупреждение(, НСтр("ru='Выберите пользователя домена.';uk='Виберіть користувача домена.'"));
		Возврат;
	КонецЕсли;
