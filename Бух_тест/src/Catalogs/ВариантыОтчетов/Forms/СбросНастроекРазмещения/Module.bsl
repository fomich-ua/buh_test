...
"вариантов отчетов (%1 шт.).';uk='Скинуто настройки розміщення"
"варіантів звітів (%1 шт.).'");
		ОповещениеТекст = СтрЗаменить(ОповещениеТекст, "%1", Формат(КоличествоВариантов, "ЧН=0; ЧГ=0"));
...
"- Выбраны варианты дополнительных или внешних отчетов.';uk='Скидання настройки розміщення вибраних варіантів звітів не потрібно по одній або кількох причин:"
