...
Функция ПроверитьПодключениеКСерверуИсходящейПочты()
	...
	Тело = НСтр("ru='Это сообщение отправлено подсистемой электронной почты 1С:Предприятие';uk='Це повідомлення відправлене підсистемою електронної пошти 1С:Підприємство'");
