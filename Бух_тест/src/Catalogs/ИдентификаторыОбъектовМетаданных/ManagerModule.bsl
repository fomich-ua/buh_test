	...
	Попытка
		...
		Если ЗначениеЗаполнено(СписокКритичныхИзменений) Тогда
			ЗаписьЖурналаРегистрации(
				НСтр("ru='Идентификаторы объектов метаданных.Выполнены критичные изменения';uk=""Ідентифікатори об'єктів метаданих.Виконано критичні зміни""",
...
"""%1"".';uk='Помилка завантаження ідентифікаторів об''єктів метаданих."
...
"""%1"" не соответствует полному имени ""%2"".';uk='Помилка завантаження ідентифікаторів об''єктів метаданих."
...
Процедура ПроверкаИспользования() Экспорт
	...
	Если СтандартныеПодсистемыПовтИсп.ОтключитьСправочникИдентификаторыОбъектовМетаданных() Тогда
		ВызватьИсключение
			НСтр("ru='Справочник ""Идентификаторы объектов метаданных"" не используется.';uk='Довідник ""Ідентифікатори об''єктів метаданих"" не використовується.'");
	КонецЕсли;
...
"нажмите кнопку Отключить или программно очистите константу Главный узел.';uk='Довідник ""Ідентифікатори об''єктів метаданих"" не може використовуватися"
"в інформаційній базі з непідтвердженим скасуванням головного вузла."
""
"Для відновлення зв''язку з головним вузлом запустите 1C:Підприємство й"
"натисніть кнопку Відновити або програмно встановите головний вузол,"
"збережений у константі Головний вузол."
""
"Для підтвердження скасування зв''язку з головним вузлом запустите 1C:Підприємство й"
"натисніть кнопку Відключити або програмно очистите константу Головний вузол.'");
	КонецЕсли;
...
"Не следует называть подсистемы одинаково, либо использовать более новую версию платформы.';uk='Помилка при пошуку дочірньої підсистеми по повному імені (при пошуку ""%1"" була знайдена ""%2"")."
