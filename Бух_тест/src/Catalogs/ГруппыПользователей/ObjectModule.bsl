...
"может быть только в корне.';uk='Визначена група ""Всі користувачі"""
"може бути тільки в корені.'");
		КонецЕсли;
		Если Состав.Количество() > 0 Тогда
			ВызватьИсключение
				НСтр("ru='Добавление пользователей в группу"
"""Все пользователи"" не поддерживается.';uk='Додавання користувачів у групу"
"""Усі користувачі"" не підтримується.'");
	...
	Иначе
		Если Родитель = Справочники.ГруппыПользователей.ВсеПользователи Тогда
			ВызватьИсключение
				НСтр("ru='Предопределенная группа ""Все пользователи"""
"не может быть родителем.';uk='Визначена група ""Всі користувачі"""
