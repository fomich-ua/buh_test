...
Функция СуществующийЭлемент() Экспорт
	...
	Если Выборка.Следующий() Тогда
		Результат = Новый Структура("ОписаниеОшибки", СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='С кодом %1 уже существует страна %2. Измените код или используйте уже существующие данные.';uk='З кодом %1 уже існує країна %2. Змініть код або використайте вже існуючі дані.'"), 
