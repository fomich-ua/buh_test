...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокВыбора.Добавить(Неопределено, " "); // НСтр("ru='Все';uk='Всі'")
	...
	СписокВыбора.Добавить(Неопределено, " "); //НСтр("ru='Все отчеты и обработки';uk='Всі звіти й обробки'")
...
"Выберите дополнительный отчет или обработку.';uk=""Команда не може бути виконана для зазначеного об'єкта."
"Виберіть додатковий звіт або обробку."""));
		Возврат Ложь;
	КонецЕсли;
	Если ДанныеСтроки.ЭтоГруппа Тогда
		ПоказатьПредупреждение(, НСтр("ru='Команда не может быть выполнена для группы."
"Выберите дополнительный отчет или обработку.';uk='Команда не може бути виконана для групи."
"Виберіть додатковий звіт або обробку.'"));
		Возврат Ложь;
	КонецЕсли;
	Возврат Истина;
...
Функция ИзменениеПубликации(ВариантПубликации)
	...
	Если ВыделенныеСтроки.Количество() = 0 Тогда
		ТекстСообщения = НСтр("ru='Не выбран ни один дополнительный отчет (обработка)';uk='Не обраний жоден додатковий звіт (обробка)'");
	...
	ВыводОповещения.Заголовок = НСтр("ru='Изменена публикация';uk='Змінена публікація'");
