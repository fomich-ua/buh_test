...
&НаКлиенте
Процедура АдресТолькоУкраинскийПриИзменении(Элемент)
	
	ИзменитьРеквизитыПриИзмененииТолькоУкраины();
	ИзменитьОтображениеПриИзмененииТолькоУкраины();
...
&НаКлиенте
Процедура ИзменитьОтображениеПриИзмененииТолькоУкраины()
	
	Элементы.ПроверятьПоКлассификатору.Доступность = Объект.АдресТолькоУкраинский;
	Элементы.СкрыватьНеактуальныеАдреса.Доступность = Объект.АдресТолькоУкраинский;
	
КонецПроцедуры

&НаКлиенте
Процедура ИзменитьРеквизитыПриИзмененииТолькоУкраины()
	
	Если Не Объект.АдресТолькоУкраинский Тогда
