...
"Используйте команду ""Создать"" в списке файлов.';uk='У Веб-клієнті імпорт файлів не підтримується."
...
Процедура ОбработкаПеретаскиванияВЛинейныйСписок(ПараметрыПеретаскивания, ВладелецФайлаСписка)
	...
	ИначеЕсли ТипЗнч(ПараметрыПеретаскивания.Значение) = Тип("Массив") Тогда
		...
		Если КоличествоОшибок > 0 Тогда
			...
			Иначе
				КраткийТекстВсехОшибок = СтрЗаменить(НСтр("ru='При выполнении возникли ошибки (%1).';uk='При виконанні виникли помилки (%1).'"), "%1", Строка(КоличествоОшибок));
