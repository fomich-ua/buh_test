...
""
"Скопировать сведения об ЭП в новый файл?';uk='Файл ""%1"" підписаний."
...
""
"Закрыть карточку?';uk='Файл зайнятий для редагування."
""
"Закрити картку?'");
...
""
"Данные будут записаны.';uk='Дані ще не записані. Виконання команди"
"""Підписати"" можливо тільки після запису даних."
""
...
Процедура ПроверитьОднуПодпись(ДанныеСтроки, МенеджерКриптографии, Пароль)
	...
	Исключение
		ДанныеСтроки.Статус =
			НСтр("ru='Неверна.';uk='Невірна.'") + " " + КраткоеПредставлениеОшибки(ИнформацияОбОшибке());
