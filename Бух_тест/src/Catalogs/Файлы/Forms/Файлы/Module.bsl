...
"Используйте команду ""Создать"" в списке файлов.';uk='У веб-клієнті імпорт папок не підтримується."
...
"наименование или код которых содержит ""%1"".';uk='Не вдалося знайти файл або папку,"
			...
			Если Действие = ДействиеПеретаскивания.Копирование Тогда
				...
				Если ЗначениеПеретаскивания.Количество() = 1 Тогда
					...
					ОповещениеТекст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru='Файл ""%1"""
"скопирован в папку ""%2""';uk=' Файл ""%1"""
...
"перенесений в папку ""%2""'"),
		...
		ИначеЕсли ТипЗначения = Тип("СправочникСсылка.ПапкиФайлов") Тогда
			...
			Если ЗначениеПеретаскивания.Количество() = 1 Тогда
				...
				ОповещениеТекст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Папка ""%1"""
"перенесена в папку ""%2""';uk='Папка ""%1"""
