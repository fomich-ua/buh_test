...
"т.к. он занят для редактирования пользователем ""%2"".';uk='Неможливо видалити файл ""%1"","
...
"т.к. он занят для редактирования пользователем ""%2"".';uk='Неможливо перейменувати файл ""%1"","
"т. я. він зайнятий для редагування користувачем ""%2"".'"),
					НаименованиеВИБ,
					Строка(Редактирует));
			КонецЕсли;
