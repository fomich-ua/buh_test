...
Процедура ОбновитьНоменклатуруГТД()
	...
	Исключение
		ТекстОшибки = НСтр("ru = 'Не удалось обновить данные справочника """+Метаданные.Справочники.НоменклатураГТД.Синоним+""". Отображение номера ГТД в наименовании этого справочника может быть не правильным!'");
