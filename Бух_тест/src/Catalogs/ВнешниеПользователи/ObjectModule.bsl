...
"объект информационной базы.';uk=""Для зовнішнього користувача не встановлений"
"об'єкт інформаційної бази.""");
	Иначе
		ТекстОшибки = "";
...
"объект информационной базы.';uk=""У зовнішнього користувача не можна змінювати"
"об'єкт інформаційної бази.""");
		КонецЕсли;
	КонецЕсли;
