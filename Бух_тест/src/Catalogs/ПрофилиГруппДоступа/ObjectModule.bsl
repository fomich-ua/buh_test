...
"Поставляемый профиль уже существует:';uk='Помилка при записі профілю ""%1""."
"Профіль, що поставляє, уже існує:'"),
				Наименование);
			
			ПодробноеПредставлениеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Ошибка при записи профиля ""%1""."
"Идентификатор поставляемых данных ""%2"" уже используется в профиле:';uk='Помилка при записі профілю ""%1""."
"Ідентифікатор даних, що поставляються, ""%2"" уже використовується в профілі:'"),
			...
			Иначе
				ЗаписьЖурналаРегистрации(
					НСтр("ru='Управление доступом.Нарушение однозначности поставляемого профиля';uk='Управління доступом.Порушення однозначності профілю, що поставляє'",
