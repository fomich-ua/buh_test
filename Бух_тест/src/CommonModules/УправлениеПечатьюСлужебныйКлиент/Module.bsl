...
// Проверяет наличие установленного расширения работы с файлами в веб-клиенте и предлагает установку в случае отсутствия.
//
// Параметры:
...
Процедура ПоказатьВопросОбУстановкеРасширенияРаботыСФайлами(ОписаниеОповещения) Экспорт
	#Если ВебКлиент Тогда
		ТекстСообщения = НСтр("ru='Для продолжения печати необходимо установить расширение для веб-клиента 1С:Предприятие.';uk='Для продовження друку необхідно встановити розширення для веб-клієнта 1С:Підприємство.'");
