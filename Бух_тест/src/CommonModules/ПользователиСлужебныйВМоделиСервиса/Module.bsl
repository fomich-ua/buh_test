...
"доступно только неразделенным пользователям.';uk='Оновлення користувача за повідомленням"
...
"пользователя сервиса в элементе справочника.';uk='Помилка при записі користувача ""%1""."
...
"уже используется в элементе ""%3"".';uk='Помилка при записі користувача ""%1""."
