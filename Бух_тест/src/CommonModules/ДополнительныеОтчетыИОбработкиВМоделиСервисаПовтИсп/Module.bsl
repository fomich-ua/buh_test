...
Функция РасширенныеОписанияПричинБлокировки() Экспорт
	...
	Результат.Вставить(Причины.БлокировкаАдминистраторомСервиса, НСтр("ru='Использование дополнительной обработки запрещено из-за нарушений правил сервиса!';uk='Використання додаткової обробки заборонене через порушеня правил сервісу!'"));
	Результат.Вставить(Причины.БлокировкаВладельцем, НСтр("ru='Использование дополнительной обработки запрещено владельцем обработки!';uk='Використання додаткової обробки заборонене власником обробки!'"));
