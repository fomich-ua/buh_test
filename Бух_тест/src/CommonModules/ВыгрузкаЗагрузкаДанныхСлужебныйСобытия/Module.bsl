...
// Прцелуры и функции данного модуля содержат служебные события, на которые может подписаться
...
//
// Влозвращаемое значение:
//	Соответствие:
//		Ключ - Строка - имя метаданных, которые зависят от других метаданных.
//		Значение - Массив - массив имен метаданных от которых зависит метаданное, хранящееся в ключе.
//
