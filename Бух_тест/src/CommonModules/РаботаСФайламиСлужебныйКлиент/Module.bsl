...
"т.к. он никем не занят.';uk='Неможливо звільнити файл ""%1"","
"т.к. він ніким не зайнятий.'"),
	...
	Иначе
		...
		СтрокаОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Невозможно освободить файл ""%1"","
"т.к. он занят пользователем ""%2"".';uk='Неможливо звільнити файл ""%1"","
...
""
"Освободить файл?';uk='Не вдалося помістити файл"
"""%1"" (%2),"
...
"в хранилище файлов, т.к. он не найден в рабочем каталоге."
""
"Освободить файл?';uk='Не вдалося помістити файл ""%1"","
"у сховище файлів, тому що він не знайдений у робочому каталозі."
""
"Звільнити файл?'"),
					Строка(ПараметрыВыполнения.ДанныеФайла.Ссылка));
...
"возможно он заблокирован другой программой.';uk='Не вдалося помістити файл ""%1"" у сховище файлів,"
...
"Пожалуйста, подождите.';uk='Виконується передача файлу ""%1"" (%2 Мб)..."
...
"""%1""."
""
"Повторить операцию?';uk='Не вдалось помістити файл в сховище файлів з причини:"
"""%1""."
""
"Повторити операцію?'"),
...
"обновлен и освобожден.';uk='Файл ""%1"""
"оновлено й звільнено.'");
		Иначе
			ШаблонПояснения = НСтр("ru='Файл ""%1"""
"не изменился и освобожден.';uk='Файл ""%1"""
...
"""%2""."
""
"Повторить операцию?';uk='Не вдалося помістити файл ""%1"""
...
Процедура ОбновитьИзФайлаНаДиске(ОбработчикРезультата, ДанныеФайла, ИдентификаторФормы) Экспорт
	...
	Если ПодключитьРасширениеРаботыСФайлами() Тогда
		...
		Диалог.Фильтр = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Файл (*.%1)|*.%1|Все файлы (*.*)|*.*';uk='Файл (*. %1)|*. %1|Все файли (*.*)|*.*'"),
...
Процедура ОбновитьИзФайлаНаДискеЗапуск(ПараметрыВыполнения) Экспорт
	...
	Если ПараметрыВыполнения.ФайлЗашифрован Тогда
		...
		ПараметрыФормы.Вставить("Заголовок", НСтр("ru='Введите пароль для расшифровки';uk='Введіть пароль для розшифрування'"));
...
"обновления из файла на диске.';uk='Файл ""%1"""
...
Процедура ЗанятьФайлПоСсылкеПослеУстановкиРасширения(РасширениеУстановлено, ПараметрыВыполнения) Экспорт
	...
	ПоказатьОповещениеПользователя(
		...
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Файл ""%1"""
"занят для редактирования.';uk='Файл ""%1"""
...
""
"Продолжить?';uk='Скасування редагування файлів може"
...
""
"Продолжить?';uk='Скасування редагування файлу"
"""%1"""
...
Процедура ОпубликоватьФайлыПоСсылкамПослеПомещенияФайлаНаСервер(Результат, ПараметрыВыполнения) Экспорт
	...
	ПоказатьОповещениеПользователя(
		...
		,
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Сохранены изменения файлов (%1 из %2).';uk='Збережено зміни файлів (%1 з %2).'"),
			ПараметрыВыполнения.ДанныеФайлов.Количество(),
			ПараметрыВыполнения.МассивФайлов.Количество()),
		БиблиотекаКартинок.Информация32);
...
"%2."
""
"Освободить файл?';uk='Не вдалося помістити файл ""%1"" у сховище файлів:"
...
Процедура ОсвободитьФайлы(ОбработчикРезультата, ОбъектыСсылка) Экспорт
	...
	Если СписокНевозможноОсвободить.Количество() > 0 Тогда
		ДиалогВопросаСоСписком(
			...
			НСтр("ru='Освободить файлы';uk='Звільнити файли'"));
	Иначе
		ПоказатьВопрос(
			Обработчик,
...
""
"Освободить файлы?';uk='Звільнення файлів може привести"
"до втрати ваших змін."
""
"Звільнити файли?'"),
			РежимДиалогаВопрос.ДаНет,
			,
...
"из рабочего каталога?';uk='Вилучити файл ""%1"""
"з робочого каталогу?'");
...
"в рабочий каталог.';uk='Помилка одержання файлу зі сховища файлів"
"у робочий каталог.'"));
...
""
"Получить файл из хранилища файлов?';uk='Файл ""%1"""
"відсутній у робочому каталозі."
""
"Одержати файл зі сховища файлів?'"),
			ИмяФайла),
		РежимДиалогаВопрос.ДаНет);
...
"""%1""."
""
"Удалить его из рабочего каталога?';uk='Виконується очищення робочого каталогу при додаванні файлу."
""
...
"""%1""."
""
"Удалить его из рабочего каталога?';uk='У сховище файлів не знайдений файл"
"""%1""."
""
"Вилучити його з робочого каталогу?'"),
					ПараметрыВыполнения.ИмяКаталога + ПараметрыВыполнения.Элемент.Путь);
...
"%2';uk=""Довжина шляху до файлу (робітник каталог плюс ім'я файлу) перевищує %1 символів"
"%2"""),
...
"%2"
""
"Выбрать другой основной рабочий каталог?';uk='Довжина шляху до файлу перевищує %1 символів:"
" %2"
""
...
""
"Переименуйте один из файлов в информационной базе.';uk='У робочому каталозі уже є файл"
"""%1"","
...
"(У двух папок не должно быть одинакового рабочего каталога).';uk='У робочому каталозі уже є файл"
"""%1"","
...
"""%2"".';uk='Довжина повного шляху до файлу (робітник каталог плюс ім''я файлу) перевищує %1 символів"
"""%2"".'"),
		ПараметрыВыполнения.МаксимальнаяДлинаПолногоПути,
		ПараметрыВыполнения.ПолноеИмяФайла);
...
"(Содержимое рабочего каталога будет перенесено в выбранный каталог).';uk='Довжина повного шляху до файлу (робітник каталог плюс ім''я файлу) перевищує %1 символів"
"""%2""."
""
"Вибрати інший основний робочий каталог?"
...
""
"Повторить операцию?';uk='Не вдалося скопіювати файл"
"""%1""."
...
"""%1"""
"в каталог"
"""%2"".';uk='Не вдалося скопіювати назад уміст каталогу"
"""%1"""
"у каталог"
"""%2"".'"),
			ПараметрыВыполнения.КаталогПриемника,
...
"Возможно он занят другим приложением."
""
"Повторить операцию?';uk='Не вдалося вилучити файл"
"""%1""."
"Можливо він зайнятий іншою прикладною програмою."
""
"Повторити операцію?'"),
...
""
"Продолжить импорт папки?';uk='Папка ""%1"" уже існує."
""
...
Процедура ИмпортФайловПослеЦиклаПродолжение(ПараметрыВыполнения)
	...
	Если ПараметрыВыполнения.МассивСтруктурВсехФайлов.Количество() > 1 Тогда
		...
		ТекстСостояния = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Импорт файлов завершен. Импортировано %1 файлов';uk='Імпорт файлів завершений. Імпортоване %1 файлів'"), Строка(ПараметрыВыполнения.МассивСтруктурВсехФайлов.Количество()) );
			
		Если ПараметрыВыполнения.РежимЗагрузки Тогда
			ТекстСостояния = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Загрузка файлов завершена. Загружено %1 файлов';uk='Завантаження файлів завершено. Завантажене %1 файлів'"), Строка(ПараметрыВыполнения.МассивСтруктурВсехФайлов.Количество()) );
		КонецЕсли;
...
"Возможно, файл был изменен.';uk='Дата зміни файлу ""%1"""
...
Процедура СохранитьКакСРасширениемПослеПроверкиЗашифрован(ПараметрыВыполнения)
	...
	Фильтр = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Все файлы (*.%1)|*.%1';uk='Всі файли (*. %1)|*. %1'"), Расширение, Расширение);
...
"Пожалуйста, подождите.';uk='Виконується збереження файлу ""%1"" (%2 Мб)..."
"Будь ласка, почекайте.'"),
		ИмяФайла, 
		ФайловыеФункцииСлужебныйКлиентСервер.ПолучитьСтрокуСРазмеромФайла(РазмерВМб));
...
"""%1""."
"Пожалуйста, подождите.';uk='Іде збір інформації про каталог"
"""%1""."
"Будь ласка, почекайте.'"),
				Путь));
...
Процедура ВыбратьСертификатыДляШифрованияПослеВыбораЛичногоСертификата(Результат, ПараметрыВыполнения) Экспорт
	...
	Если ТипЗнч(Результат) <> Тип("Структура") Тогда
		ТекстПредупреждения = НСтр("ru='Не выбран персональный сертификат для шифрования.';uk='Не обраний персональний сертифікат для шифрування.'");
		ВернутьРезультатПослеПоказаПредупреждения(ПараметрыВыполнения.ОбработчикРезультата, ТекстПредупреждения, Ложь);
		Возврат;
	КонецЕсли;
...
""
"Продолжить шифрование файла?';uk='Буде виконано шифрування всіх %1 версій файлу."
"Це може забрати тривалий час."
""
"Продовжити шифрування файлу?'"),
			КоличествоВерсий);
...
Процедура ЗашифроватьПослеОтветаНаВопросПродолжить(Ответ, ПараметрыВыполнения) Экспорт
	...
	ТекстСостояния = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Получение всех версий файла ""%1"".';uk='Одержання всіх версій файлу ""%1"".'"),
		ПараметрыВыполнения.ДанныеФайла.Ссылка);
	...
	ТекстСостояния = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Шифрование всех версий файла ""%1"".';uk='Шифрування всіх версій файлу ""%1"".'"),
		ПараметрыВыполнения.ДанныеФайла.Ссылка);
	Состояние(ТекстСостояния);
...
"Это может занять продолжительное время. "
""
"Продолжить расшифровку файла?';uk='Буде виконана розшифровка всіх версій файлу (%1)."
"Це може забрати тривалий час. "
""
"Продовжити розшифровку файлу?'"),
			КоличествоВерсий);
...
Процедура РасшифроватьПослеОтветаНаВопросПродолжить(Ответ, ПараметрыВыполнения) Экспорт
	...
	ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Выполняется получение всех версий файла ""%1"".';uk='Виконується отримання всіх версій файлу ""%1""'"),
	...
	ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Выполняется расшифровка всех версий файла ""%1"".';uk='Виконується розшифровка всіх версій файлу ""%1"".'"),
		ПараметрыВыполнения.ФайлСсылка);
...
"Пожалуйста, подождите...';uk='Іде збереження файлу ""%1"" (%2 Мб)."
"Будь ласка, почекайте...'"),
		ИмяФайла,
		ФайловыеФункцииСлужебныйКлиентСервер.ПолучитьСтрокуСРазмеромФайла(РазмерВМб));
	Состояние(ТекстСостояния);
...
Процедура ДобавитьПодписьИзФайла(ОбработчикРезультата, ДанныеФайла, УникальныйИдентификатор = Неопределено) Экспорт
	...
	#Если ВебКлиент Тогда
		ТекстПредупреждения = НСтр("ru='В Веб-клиенте добавление электронной подписи из файла не поддерживается.';uk='У Веб-клієнті додавання електронного підпису з файлу не підтримується.'");
		ВернутьРезультатПослеПоказаПредупреждения(ОбработчикРезультата, ТекстПредупреждения, Ложь);
		Возврат;
	#КонецЕсли
...
"""%1"""
"во временное хранилище.';uk='Помилка приміщення файлу"
"""%1"""
"у тимчасове сховище.'"),
...
"""%1"".';uk='Доданий підпис із файлу для"
"""%1"".'"),
			ФайлСсылка);
	Иначе
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Добавлены подписи из файлов для"
"""%1"".';uk='Додані підписи з файлів для"
"""%1"".'"),
			ФайлСсылка);
	КонецЕсли;
...
"""%1"".';uk='Невірний шлях або відсутні права на запис у каталог"
"""%1"".'"),
				ИмяКаталога);
...
"уже есть файлы."
""
"Выберите другой каталог.';uk='В обраному робочому каталозі"
"""%1"""
"уже є файли."
""
