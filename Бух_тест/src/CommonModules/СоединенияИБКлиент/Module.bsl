...
//
Процедура ПриОткрытииФормыОшибкиУстановкиМонопольногоРежима(Оповещение) Экспорт
	
	ОткрытьФорму("Обработка.БлокировкаРаботыПользователей.Форма.ОшибкаУстановкиМонопольногоРежима",
		, , , , , Оповещение);
...
Процедура УстановитьПризнакРаботаПользователейЗавершается(Значение) Экспорт
	...
	Если ТипЗнч(ПараметрыЗавершенияРаботыПользователей) <> Тип("Структура") Тогда
		ПараметрыЗавершенияРаботыПользователей = Новый Структура;
	КонецЕсли;
	
	ПараметрыЗавершенияРаботыПользователей.Вставить("РаботаПользователейЗавершается", Значение);
...
Процедура СохранитьПараметрыАдминистрирования(Значение) Экспорт
	...
	ПараметрыЗавершенияРаботыПользователей.Вставить("ПараметрыАдминистрирования", Значение);
