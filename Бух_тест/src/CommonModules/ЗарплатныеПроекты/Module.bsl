...
Функция СообщениеПроверкиНомераЛицевогоСчетаНаСоответствиеТребованиям(ФизическоеЛицо, ЗарплатныйПроект, Знач НомерЛицевогоСчета) Экспорт
	...
	Если СтрДлина(НомерЛицевогоСчета) < 16 Тогда
		
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='У сотрудника %1 неверный номер лицевого счета, он должен содержать не менее 16 символов - %2.';uk='У співробітника %1 невірний номер особового рахунку, він повинен містити не менш ніж 16 символів - %2.'"),
				ФизическоеЛицо,
				НомерЛицевогоСчета);
