...
Процедура ПолучитьТекстПоясненияДляРезультатовОбновленияПрограммы(ТекстПодсказки) Экспорт
	...
	ТекстПодсказки = НСтр("ru='Сведения о результатах обновления версии программы можно также открыть из раздела ""Рабочий стол"" - ""Описание изменений программы"".';uk='Відомості про результати оновлення версії програми можна також відкрити з розділу ""Робочий стіл"" - ""Опис змін програми"".'");
