...
"ВыгрузкаЗагрузкаСовиестноРазделенныхДаннных.ЗаполнитьКэшСовместноРазделенныхОбъектов()';uk=""Об'єкт метаданих %1 не може бути обробником ВыгрузкаСовместноРазделенныхДанных.ПередВыгрузкойОбъекта(),"
...
"Если после редактирования структуры метаданных конфигурации кэш не обновлялся - необходимо выполнять"
"обновление кэша совместно-разделенных объектов с помощью вызова метода"
"ВыгрузкаЗагрузкаСовиестноРазделенныхДаннных.ЗаполнитьКэшСовместноРазделенныхОбъектов()';uk=""Об'єкт метаданих %1 не може бути обробником ВыгрузкаСовместноРазделенныхДанных.ПередЗагрузкойОбъекта(),"
"т. я. відсутній в кеші сумісно-розділених об'єктів."
"Якщо після редагування структури метаданих конфігурації кеш не оновлювався - необхідно виконувати"
"оновлення кешу спільно-розподілених об'єктів за допомогою виклику методу"
"ВыгрузкаЗагрузкаСовиестноРазделенныхданнных.ЗаполнитьКэшСовместноРазделенныхобъектов()""", Метаданные.ОсновнойЯзык.КодЯзыка),
	...
	Если ВыгрузкаЗагрузкаДанныхСлужебный.ЭтоНаборЗаписей(Объект.Метаданные()) Тогда
