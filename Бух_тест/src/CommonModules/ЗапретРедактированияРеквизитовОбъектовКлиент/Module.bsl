...
"Поиск мест использования может занять длительное время.';uk='Для того щоб не допустити неузгодженості даних у програмі, що випливають реквізити не доступні для редагування:"
" %1."
""
"Перед тим, як дозволити їхнє редагування, рекомендується оцінити наслідки,"
"перевіривши всі місця використання цього елемента в програмі."
"Пошук місць використання може забрати тривалий час.'");
...
"Поиск мест использования может занять длительное время.';uk='Для того щоб не допустити неузгодженості даних у програмі, реквізит %1 не доступний для редагування."
""
"Перед тим, як дозволити його редагування, рекомендується оцінити наслідки,"
"перевіривши всі місця використання %2 у програмі."
"Пошук місць використання може забрати тривалий час.'");
	КонецЕсли;
	...
	Иначе
		ОбъектыПредставление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку( 
			НСтр("ru='выбранных элементов (%1)';uk='обраних елементів (%1)'"), МассивСсылок.Количество());
	КонецЕсли;
...
// на основе имен реквизитов указанных в модуле мененджера объекта, исключая реквизиты,
