...
#Если ВебКлиент Тогда
	ТекстУточнения = НСтр("ru='При работе через веб требуется браузер Internet Explorer под управлением операционной системы Windows. См. также главу документации ""Настройка веб-браузеров для работы в веб-клиенте""';uk='При роботі через веб потрібен браузер Internet Explorer під керуванням операційної системи Windows. Див. також главу документації ""Настройка веб-браузерів для роботи у веб-клиєнті""'");
#Иначе		
	ТекстУточнения = "";	
#КонецЕсли
	ТекстИсключения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Не удалось сформировать печатную форму: %1. "
"Для вывода печатных форм в формате Microsoft Word требуется, чтобы на компьютере был установлен пакет Microsoft Office. %2';uk=""Не вдалося сформувати друковану форму: %1. "
