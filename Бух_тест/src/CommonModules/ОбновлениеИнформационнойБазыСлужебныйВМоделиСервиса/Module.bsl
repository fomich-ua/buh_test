...
Процедура СформироватьПланОбновленияОбластиДанных(ИдентификаторБиблиотеки, ВсеОбработчики, 
	...
	Если ОбщегоНазначенияПовтИсп.РазделениеВключено()
		...
		ПланОбновленияОбластиДанных = ОбновлениеИнформационнойБазыСлужебный.ОбработчикиОбновленияВИнтервале(
			ОбработчикиОбновления, ИсходнаяВерсияИБ, ВерсияМетаданныхИБ, Истина);
...
"Требуется план обновления на версию %2, найден план для обновления на версию %3';uk='Виявлено некоректний план оновлення бібліотеки %1"
...
"Обратитесь к администратору.';uk='Не виконана загальна частина оновлення інформаційної бази."
	...
	Если КлючЗаписи <> Неопределено Тогда
		...
		Исключение
			ЗаписьЖурналаРегистрации(ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации() + ". " 
				+ НСтр("ru='Обновление области данных';uk='Оновлення області даних'", Метаданные.ОсновнойЯзык.КодЯзыка),
				УровеньЖурналаРегистрации.Ошибка,,,
...
"недоступен из сеансов с установленным значением разделителей модели сервиса!';uk='Виклик функції ОбновлениеИнформационнойБазыСлужебныйповтисп.МинимальнаяВерсияИБ()"
"недоступний з сеансів з установленим значенням роздільників моделі сервісу!'");
	КонецЕсли;
