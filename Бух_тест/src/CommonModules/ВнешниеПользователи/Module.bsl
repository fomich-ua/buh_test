...
"установлен для нескольких внешних пользователей.';uk='Помилка в базі даних:"
...
"установлений для декількох зовнішніх користувачів.'"),
	...
	Иначе
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Ошибка в базе данных:"
"Для внешнего пользователя ""%1"" не задан объект авторизации.';uk='Помилка в базі даних:"
