...
Функция ПолучитьСведенияОКомиссии(ДокументОбъект) Экспорт
	...
	Если ЗначениеЗаполнено(ДокументОбъект.ПредседательКомиссии) Тогда
		...
		СоставКомиссии.Вставить("ПредседательКомиссииДолжность", ДанныеПредседательКомиссии.Должность);
	...
	Если ЗначениеЗаполнено(ДокументОбъект.ПервыйЧленКомиссии) Тогда
		...
		СоставКомиссии.Вставить("ПервыйЧленКомиссииДолжность", ДанныеПервыйЧленКомиссии.Должность);
	...
	Если ЗначениеЗаполнено(ДокументОбъект.ВторойЧленКомиссии) Тогда
		...
		СоставКомиссии.Вставить("ВторойЧленКомиссииДолжность", ДанныеВторойЧленКомиссии.Должность);
	...
	Если ЗначениеЗаполнено(ДокументОбъект.ТретийЧленКомиссии) Тогда
		...
		СоставКомиссии.Вставить("ТретийЧленКомиссииДолжность", ДанныеТретийЧленКомиссии.Должность);
