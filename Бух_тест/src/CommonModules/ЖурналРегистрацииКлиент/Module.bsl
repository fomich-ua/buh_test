...
//   ЗаписатьСобытия     - Булево - выполнить запись всех ранее накопленных сообщений в журнал регистрации (обращение к серверу).
//
// Пример:
...
"%1';uk=""Цей запис журналу реєстрації пов'язаний з даними, але відобразити їх неможливо."
"%1""");
...
Процедура ПросмотрТекущегоСобытияВОтдельномОкне(Данные) Экспорт
	...
	ОткрытьФорму("Обработка.ЖурналРегистрации.Форма.ФормаСобытия", СобытиеЖурналаРегистрацииВСтруктуру(Данные));
...
//
Функция СобытиеЖурналаРегистрацииВСтруктуру(Данные) Экспорт
