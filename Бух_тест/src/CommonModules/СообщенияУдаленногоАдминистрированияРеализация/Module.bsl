...
Процедура УстановитьПараметрыИБ(Параметры) Экспорт
	...
	Попытка
		...
		Для каждого КлючИЗначение Из Параметры Цикл
			...
			Если СтрокаПараметра = Неопределено Тогда
				...
				ЗаписьЖурналаРегистрации(НСтр("ru='УдаленноеАдминистрирование.УстановитьПараметрыИБ';uk='УдаленноеАдминистрирование.УстановитьПараметрыИБ'", 
	...
	Исключение
		ОтменитьТранзакцию();
		ЗаписьЖурналаРегистрации(НСтр("ru='Установка параметров ИБ';uk='Установка параметрів ІБ'", 
			ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
...
"Ошибка: %2';uk='Вказано неправильну адресу електронної пошти: %1"
"Помилка: %2'");
