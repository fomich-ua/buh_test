...
"из сценария или из контекста клиентского приложения!';uk='Некоректний виклик функції загального модуля ДополнительныеОтчетыИОбработкиВБезопасномРежимеВызовСервера!"
