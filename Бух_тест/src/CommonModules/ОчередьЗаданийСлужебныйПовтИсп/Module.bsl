///////////////////////////////////////////////////////////////////////////////////
// ОчередьЗаданийСлужебныйПовтИсп: Работа с очередью заданий.
//
///////////////////////////////////////////////////////////////////////////////////
...
Функция СоответствиеИменМетодовПсевдонимам() Экспорт
	...
	Для каждого Обработчик Из ОбработчикиСобытия Цикл
		Обработчик.Модуль.ПриОпределенииПсевдонимовОбработчиков(МетодыКонфигурации);
	КонецЦикла;
...
Функция СоответствиеОбработчиковОшибокПсевдонимам() Экспорт
	...
	Для каждого Обработчик Из ОбработчикиСобытия Цикл
		Обработчик.Модуль.ПриОпределенииОбработчиковОшибок(ОбработчикиОшибок);
	КонецЦикла;
	...
	Для каждого ОписаниеПараметра Из ОчередьЗаданийСлужебныйПовтИсп.ПараметрыЗаданийОчереди() Цикл
		...
		Если СправочникЗаданий <> Неопределено Тогда
			...
			Если ОписаниеПараметра.РазделениеДанных Тогда
				...
				Если Не ОбщегоНазначенияПовтИсп.ЭтоРазделеннаяКонфигурация() ИЛИ Не ОбщегоНазначения.ЭтоРазделенныйОбъектМетаданных(СправочникЗаданий, ОбщегоНазначенияПовтИсп.РазделительВспомогательныхДанных()) Тогда
