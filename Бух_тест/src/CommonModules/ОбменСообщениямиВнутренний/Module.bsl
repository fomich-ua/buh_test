...
Процедура ПриЗагрузкеДанных(СтандартнаяОбработка,
	...
	Попытка
		...
		Пока ВозможностьЧтенияXML(ЧтениеXML) Цикл
			...
			// В случае коллизии изменений приоритет отдаем текущей информационной базе (за исключением входящих УдалениеОбъекта от
...
"совпадающих со значениями разделителей сеанса.';uk='Обробка черги повідомлень системи запущена з сеансу з встановленими"
...
"які збігаються зі значеннями роздільників сеансу.'")
	...
	Для Каждого СправочникСообщений Из СправочникиСообщений Цикл
		...
		ЭтоНеразделенныйСправочник = Не ОбщегоНазначенияПовтИсп.ЭтоРазделеннаяКонфигурация() ИЛИ
			Не ОбщегоНазначения.ЭтоРазделенныйОбъектМетаданных(ПолноеИмяСправочника, ОбщегоНазначенияПовтИсп.РазделительВспомогательныхДанных());
...
"Параметры подключения указывают на другую конечную точку.';uk='Задані невірні параметри підключення до кінцевої точки."
