...
"Для вывода печатных форм в формате OpenOffice.org Writer требуется, чтобы на компьютере был установлен пакет OpenOffice.org. %2';uk=""Не вдалося сформувати друковану форму: %1. "
