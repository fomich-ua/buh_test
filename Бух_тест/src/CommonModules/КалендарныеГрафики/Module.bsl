		...
		Иначе 
			...
			Если ВызыватьИсключение Тогда
				ТекстИсключения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
									НСтр("ru='Невозможно определить ближайшую рабочую дату для даты %1, возможно, график работы не заполнен.';uk='Неможливо визначити найближчу робочу дату для дати %1, можливо, графік роботи не заповнений.'"), 
