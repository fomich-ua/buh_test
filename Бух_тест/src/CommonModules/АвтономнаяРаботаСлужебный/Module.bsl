...
Процедура ПриДобавленииСлужебныхСобытий(КлиентскиеСобытия, СерверныеСобытия) Экспорт
	...
	//
	СерверныеСобытия.Добавить("СтандартныеПодсистемы.РаботаВМоделиСервиса.ОбменДаннымиВМоделиСервиса\ПриСозданииАвтономногоРабочегоМеста");
...
Функция ОписаниеОграниченийПередачиДанных(АвтономноеРабочееМесто) Экспорт
	...
	Реквизиты = СтроковыеФункцииКлиентСервер.СтрокаИзМассиваПодстрок(Реквизиты);
...
Функция ДопустимыеСимволыПрефиксаАвтономногоРабочегоМеста()
	...
	Возврат "АБВГДЕЖЗИКЛМНОПРСТУФХЦЧШЭЮЯабвгдежзиклмнопрстуфхцчшэюя"; // 54 символа
...
"в файловом режиме работы информационной базы.';uk='Перший запуск автономного робочого місця повинен виконуватися"
"у файловому режимі роботи інформаційної бази.'");
	...
	ПриПродолженииНастройкиАвтономногоРабочегоМеста();
	
КонецПроцедуры

Процедура ПриПродолженииНастройкиАвтономногоРабочегоМеста()
	УстановитьПривилегированныйРежим(Истина);
...
"Завершите работу конфигуратора и повторите запуск программы.';uk='Можливо, інформаційна база відкрита в режимі конфігуратора."
...
"Возможно, справочник пользователей не включен в состав плана обмена автономной работы.';uk='Ідентифікація користувача не виконана."
...
"Работа с автономным рабочим место невозможна.';uk='В автономне робоче місце не були передані настройки."
