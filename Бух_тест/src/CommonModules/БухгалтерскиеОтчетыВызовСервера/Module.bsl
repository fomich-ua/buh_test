...
Функция ПолучитьПараметрыРасшифровкиОтчета(Адрес, ИдентификаторОбъекта, Расшифровка) Экспорт
	...
	Если ИдентификаторОбъекта = "АнализСубконто"
		...
		ПредставлениеДляАнализаСчета          = НСтр("ru='Анализ счета %Счет%';uk='Аналіз рахунка %Счет%'");
		ПредставлениеДляОборотыСчета          = НСтр("ru='Обороты счета %Счет%';uk='Обороти рахунка %Счет%'");
		ПредставлениеДляОборотыСчетаПоМесяцам = НСтр("ru='Обороты счета %Счет% по месяцам';uk='Обороти рахунка %Счет% по місяцях'");
		ПредставлениеДляОборотыСчетаПоДням    = НСтр("ru='Обороты счета %Счет% по дням';uk='Обороти рахунка %Счет% по днях'");
