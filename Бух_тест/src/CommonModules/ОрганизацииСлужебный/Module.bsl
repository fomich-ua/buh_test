...
Процедура ОбновитьПредопределенныеВидыКонтактнойИнформацииОрганизаций() Экспорт
	...
	МодульКИ.ОбновитьВидКонтактнойИнформации("ЮрАдресОрганизации", "Адрес", НСтр("ru='Юридический адрес организации';uk='Юридична адреса організації'"),
		Истина, Ложь, Ложь, 1, , ПараметрыПроверкиАдреса);
		
	МодульКИ.ОбновитьВидКонтактнойИнформации("ФактАдресОрганизации", "Адрес", НСтр("ru='Фактический адрес организации';uk='Фактична адреса організації'"),
		Истина, Ложь, Ложь, 2);
		
	МодульКИ.ОбновитьВидКонтактнойИнформации("ТелефонОрганизации", "Телефон", НСтр("ru='Телефон организации';uk='Телефон організації'"),
		Истина, Ложь, Ложь, 3, Истина);
		
	МодульКИ.ОбновитьВидКонтактнойИнформации("ФаксОрганизации", "Факс", НСтр("ru='Факс организации';uk='Факс організації'"),
		Истина, Ложь, Ложь, 4, Истина);
		
	МодульКИ.ОбновитьВидКонтактнойИнформации("EmailОрганизации", "АдресЭлектроннойПочты", НСтр("ru='Адрес электронной почты организации';uk='Адреса електронної пошти організації'"),
		Истина, Ложь, Ложь, 5, Истина);
		
	МодульКИ.ОбновитьВидКонтактнойИнформации("ПочтовыйАдресОрганизации", "Адрес", НСтр("ru='Почтовый адрес организации';uk='Поштова адреса організації'"),
		Истина, Ложь, Ложь, 6);
		
	МодульКИ.ОбновитьВидКонтактнойИнформации("ДругаяИнформацияОрганизации", "Другое", НСтр("ru='Любая другая контактная информация';uk='Будь-яка інша контактна інформація'"),
		Истина, Ложь, Ложь, 7);
