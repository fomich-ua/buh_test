...
"в сеансе внешнего пользователя.';uk='Неможливо одержати поточного користувача"
...
"в сеансе пользователя.';uk='Неможливо одержати поточного зовнішнього користувача"
