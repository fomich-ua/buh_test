...
Функция ПолучитьМенеджерКриптографии() Экспорт
	...
	Исключение
		ТекстОшибки = НСтр("ru='Ошибка при создании менеджера криптографии на сервере:';uk='Помилка при створенні менеджера криптографії на сервері:'")
			+ Символы.ПС
			+ ПодробноеПредставлениеОшибки(ИнформацияОбОшибке())
			+ Символы.ПС
			+ НСтр("ru='Укажите настройки криптографии согласно инструкции фирмы-производителя криптопровайдера.';uk='Укажіть настройки криптографії відповідно до інструкції фірми-виробника криптопровайдера.'");
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Электронная подпись';uk='Електронний підпис'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
