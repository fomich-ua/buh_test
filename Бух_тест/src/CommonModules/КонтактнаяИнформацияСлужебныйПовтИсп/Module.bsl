...
Функция СобытиеЖурналаРегистрации() Экспорт
	Возврат НСтр("ru='Контактная информация';uk='Контактна інформація'", 
...
Функция XSLT_СтруктураВАдрес() Экспорт
	...
	Для Каждого ДопАдрЭл Из КонтактнаяИнформацияКлиентСерверПовтИсп.ТипыОбъектовАдресацииАдресаРФ() Цикл
	...
	Преобразователь.ЗагрузитьИзСтроки("
		...
		|          <xsl:attribute name=""ТипАдрЭл"">" + КонтактнаяИнформацияКлиентСерверПовтИсп.КодСериализацииПочтовогоИндекса() + "</xsl:attribute>
