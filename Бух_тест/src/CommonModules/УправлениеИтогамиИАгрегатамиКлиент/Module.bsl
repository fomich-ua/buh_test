...
"(обязательная ежемесячная процедура, может занять некоторое время)';uk=""Прискорити проведення документів і формування звітів"
"(обов'язкова щомісячна процедура може зайняти певний час)""");
