...
Процедура КонтактнаяИнформацияОбновлениеИБ()  Экспорт
	...
	ПараметрыПроверкиАдреса.Вставить("АдресТолькоУкраинский", Истина);
	...
	// Пользователи
	УправлениеКонтактнойИнформацией.ОбновитьГруппуВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.СправочникПользователи, 
			НСтр("ru='Контактная информация справочника ""Пользователи""';uk='Контактна інформація довідника ""Користувачі""'", ЯзыкЗаполнения));
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.EmailПользователя,
		НСтр("ru='Email';uk='Email'", ЯзыкЗаполнения),
	    Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты,
	    НСтр("ru='Адрес электронной почты пользователя';uk='Адреса електронної пошти користувача'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 1, Истина);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ТелефонПользователя,
		НСтр("ru='Телефон';uk='Телефон'", ЯзыкЗаполнения),
	    Перечисления.ТипыКонтактнойИнформации.Телефон,
	    НСтр("ru='Контактный телефон пользователя';uk='Контактний телефон користувача'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 2, Истина);	
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ДругаяИнформацияПользователя, 
		НСтр("ru='Другое (любая другая контактная информация)';uk='Інше (будь-яка інша контактна інформація)'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Другое,
		НСтр("ru='Другая информация пользователя';uk='Інша інформація користувача'", ЯзыкЗаполнения),       Истина, Ложь, Ложь, 3, Истина);
	// Конец Пользователи
	
	// КонтактныеЛица
	УправлениеКонтактнойИнформацией.ОбновитьГруппуВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.СправочникКонтактныеЛица,
	...
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.АдресДляИнформированияКонтактныеЛица, 
		НСтр("ru='Адрес для информирования';uk='Адреса для інформування'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Адрес,
		НСтр("ru='Адрес для информирования контактных лиц';uk='Адреса для інформування контактних осіб'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 1);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ТелефонМобильныйКонтактныеЛица      , 
		НСтр("ru='Телефон мобильный';uk='Телефон мобільний'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Телефон,
		НСтр("ru='Мобильный телефон контактного лица';uk='Мобільний телефон контактної особи'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 2, Истина);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ТелефонРабочийКонтактныеЛица        , 
		НСтр("ru='Телефон рабочий';uk='Телефон робочий'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Телефон,
		НСтр("ru='Рабочий телефон контактного лица';uk='Робочий телефон контактної особи'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 3, Истина);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.EmailКонтактныеЛица                 , 
		НСтр("ru='Email';uk='Email'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты,
		НСтр("ru='Адрес электронной почты контактного лица';uk='Адреса електронної пошти контактної особи'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 4, Истина);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ДругаяИнформацияКонтактныеЛица      , 
		НСтр("ru='Другое (любая другая контактная информация)';uk='Інше (будь-яка інша контактна інформація)'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Другое,
		НСтр("ru='Любая другая контактная информация';uk='Будь-яка інша контактна інформація'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 5);
	// Конец КонтактныеЛица
	
	// Контрагенты
	УправлениеКонтактнойИнформацией.ОбновитьГруппуВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.СправочникКонтрагенты,
		НСтр("ru='Контактная информация справочника ""Контрагенты""';uk='Контактна інформація довідника ""Контрагенти""'", ЯзыкЗаполнения));
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ЮрАдресКонтрагента         , 
		НСтр("ru='Юридический адрес';uk='Юридична адреса'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Адрес,
		НСтр("ru='Юридический адрес контрагента';uk='Юридична адреса контрагента'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 1);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ФактАдресКонтрагента       , 
		НСтр("ru='Фактический адрес';uk='Фактична адреса'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Адрес,
		НСтр("ru='Фактический адрес контрагента';uk='Фактична адреса контрагента'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 2);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ПочтовыйАдресКонтрагента   , 
		НСтр("ru='Почтовый адрес';uk='Поштова адреса'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Адрес,
		НСтр("ru='Почтовый адрес контрагента';uk='Поштова адреса контрагента'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 3);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ТелефонКонтрагента         , 
		НСтр("ru='Телефон';uk='Телефон'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Телефон,
		НСтр("ru='Телефон контрагента';uk='Телефон контрагента'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 4, Истина);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ФаксКонтрагенты            , 
		НСтр("ru='Факс';uk='Факс'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Факс,
		НСтр("ru='Факс контрагента';uk='Факс контрагента'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 5, Истина);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.EmailКонтрагенты           , 
		НСтр("ru='Email';uk='Email'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты,
		НСтр("ru='Адрес электронной почты контрагента';uk='Адреса електронної пошти контрагента'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 6, Истина);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ДругаяИнформацияКонтрагенты, 
		НСтр("ru='Другое (любая другая контактная информация)';uk='Інше (будь-яка інша контактна інформація)'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Другое,
		НСтр("ru='Любая другая контактная информация';uk='Будь-яка інша контактна інформація'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 7);
	// Конец Контрагенты
	
	
	// Организации
	УправлениеКонтактнойИнформацией.ОбновитьГруппуВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.СправочникОрганизации,
		НСтр("ru='Контактная информация справочника ""Организации""';uk='Контактна інформація довідника ""Організації""'", ЯзыкЗаполнения));
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ЮрАдресОрганизации,
		НСтр("ru='Юридический адрес';uk='Юридична адреса'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Адрес,
		НСтр("ru='Юридический адрес организации';uk='Юридична адреса організації'", ЯзыкЗаполнения), Ложь, Истина, Ложь, 1, , ПараметрыПроверкиАдреса);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ФактАдресОрганизации,        
		НСтр("ru='Фактический адрес';uk='Фактична адреса'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Адрес,
		НСтр("ru='Фактический адрес организации';uk='Фактична адреса організації'", ЯзыкЗаполнения), Ложь, Истина, Ложь, 2, , ПараметрыПроверкиАдреса);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ТелефонОрганизации,          
		НСтр("ru='Телефон';uk='Телефон'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Телефон,
		НСтр("ru='Телефон организации';uk='Телефон організації'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 3, Истина);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ФаксОрганизации,             
		НСтр("ru='Факс';uk='Факс'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Факс,
		НСтр("ru='Факс организации';uk='Факс організації'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 4, Истина);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.EmailОрганизации,            
		НСтр("ru='Email';uk='Email'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты,
		НСтр("ru='Адрес электронной почты организации';uk='Адреса електронної пошти організації'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 5, Истина);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ПочтовыйАдресОрганизации,
		НСтр("ru='Почтовый адрес';uk='Поштова адреса'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Адрес,
		НСтр("ru='Почтовый адрес организации';uk='Поштова адреса організації'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 6);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ТелефонПоЮридическомуАдресуОрганизации,
		НСтр("ru='Телефон по юридическому адресу';uk='Телефон за юридичною адресою'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Телефон,
		НСтр("ru='Телефон по юридическому адресу организации';uk='Телефон за юридичною адресою організації'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 8, Истина);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ДругаяИнформацияОрганизации, 
		НСтр("ru='Другое (любая другая контактная информация)';uk='Інше (будь-яка інша контактна інформація)'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Другое,
		НСтр("ru='Любая другая контактная информация';uk='Будь-яка інша контактна інформація'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 9);
	// Конец Организации
	
	// ОсновныеСредства
	УправлениеКонтактнойИнформацией.ОбновитьГруппуВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.СправочникОсновныеСредства,
	...
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.АдресМестонахожденияОсновныеСредства, 
	    НСтр("ru='Адрес местонахождения';uk='Адреса місцезнаходження'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Адрес,
		НСтр("ru='Адрес местонахождения основного средства';uk='Адреса місцезнаходження основного засобу'", ЯзыкЗаполнения), Ложь, Истина, Ложь, 1, , ПараметрыПроверкиАдреса);
	// Конец ОсновныеСредства
	
	// ФизическиеЛица
	УправлениеКонтактнойИнформацией.ОбновитьГруппуВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.СправочникФизическиеЛица,
		НСтр("ru='Контактная информация справочника ""Физические лица""';uk='Контактна інформація довідника ""Фізичні особи""'", ЯзыкЗаполнения));
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ТелефонДомашнийФизическиеЛица,
		НСтр("ru='Телефон домашний';uk='Телефон домашній'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Телефон,
		НСтр("ru='Домашний телефон физического лица';uk='Домашній телефон фізичної особи'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 1, Истина);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.ТелефонРабочийФизическиеЛица,
		НСтр("ru='Телефон рабочий';uk='Телефон робочий'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Телефон,
		НСтр("ru='Рабочий телефон физического лица';uk='Робочий телефон фізичної особи'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 2, Истина);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.АдресПоПропискеФизическиеЛица,
		НСтр("ru='Адрес по прописке';uk='Адреса за пропискою'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Адрес,
		НСтр("ru='Адрес по прописке физического лица';uk='Адреса за пропискою фізичної особи'", ЯзыкЗаполнения), Ложь, Истина, Ложь, 3, , ПараметрыПроверкиАдреса);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.АдресМестаПроживанияФизическиеЛица,
		НСтр("ru='Адрес места проживания';uk='Адреса місця проживання'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Адрес,
		НСтр("ru='Адрес места проживания физического лица';uk='Адреса місця проживання фізичної особи'", ЯзыкЗаполнения), Ложь, Истина, Ложь, 4, , ПараметрыПроверкиАдреса);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.АдресДляИнформированияФизическиеЛица,
		НСтр("ru='Адрес для информирования';uk='Адреса для інформування'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.Адрес,
		НСтр("ru='Адрес для информирования физического лица';uk='Адреса для інформування фізичної особи'", ЯзыкЗаполнения), Ложь, Истина, Ложь, 5, , ПараметрыПроверкиАдреса);
	УправлениеКонтактнойИнформацией.ОбновитьВидКонтактнойИнформацииУкр(Справочники.ВидыКонтактнойИнформации.EMailФизическиеЛица,
		НСтр("ru='Email';uk='Email'", ЯзыкЗаполнения),
		Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты,
		НСтр("ru='Адрес электронной почты физического лица';uk='Адреса електронної пошти фізичної особи'", ЯзыкЗаполнения), Истина, Ложь, Ложь, 6, Истина);
...
Процедура ПеренестиКонтактнуюИнформациюФизЛицаВОрганизацию() Экспорт
	...
	|	ФизическиеЛицаКонтактнаяИнформация.Область,
...
Процедура УстановитьДатуТекущейВерсии() Экспорт
	...
	КонецЕсли;
 	...
 	Константы.ДатаТекущейВерсии.Установить(Дата(2015,12,01));
