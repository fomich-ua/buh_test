...
Функция ИмяРеквизитаДокумента(ИмяДокумента, Реквизит) Экспорт
	...
	Если Реквизит = "Валюта" Тогда
		
		Если Метаданные.Документы[ИмяДокумента].Реквизиты.Найти("ВалютаДокумента") <> Неопределено Тогда
			Возврат "ВалютаДокумента";
		ИначеЕсли Метаданные.Документы[ИмяДокумента].Реквизиты.Найти("Валюта") <> Неопределено Тогда
			Возврат "Валюта";
		КонецЕсли;
