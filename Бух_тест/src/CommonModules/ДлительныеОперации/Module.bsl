...
"Подробности см. в Журнале регистрации.';uk='Не вдалося виконати дану операцію. "
...
Процедура ВыполнитьПроцедуруМодуляОбъектаОбработки(Параметры, АдресХранилища) Экспорт 
	...
	Исключение
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Имя метода ""%1"" не соответствует требованиям образования имен переменных.';uk='Ім''я методу ""%1"" не відповідає вимогам утворення імен змінних.'"),
			ИмяМетода);
	КонецПопытки;
