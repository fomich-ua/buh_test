	...
	Если ФайлВременный.Существует() Тогда
		...
		Исключение
			ЗаписьЖурналаРегистрации(
				НСтр("ru='Файлы.Удаление файлов в томе при обмене';uk='Файли.Вилучення файлів у томі при обміні'",
...
Процедура ДобавитьНаДиск(
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			Иначе
				СтрокаИсключения = НСтр("ru='Неверный тип данных для добавления на том';uk='Невірний тип даних для додавання на тім'");
...
"в том ""%2"" (%3):"
"""%4"".';uk='Помилка при додаванні файлу ""%1"""
"у том ""%2"" (%3):"
"""%4"".'");
...
"Список ошибок:"
""
"%1';uk='Не вдалося додати файл ні в один з томів."
"Список помилок:"
""
"%1'");
	
	ЗаписьЖурналаРегистрации(
		НСтр("ru='Файлы.Добавление файла';uk='Файли.Додавання файлу'",
		     ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
		УровеньЖурналаРегистрации.Ошибка,
		,
		,
...
"""%1.%2""."
""
"Обратитесь к администратору.';uk='Не вдалося додати файл:"
"""%1. %2""."
""
...
"в формате UNC (\\servername\resource)';uk='Шлях до архіву з файлами томів повинен бути"
...
"в формате UNC (\\servername\resource)';uk='Шлях до файлової бази повинен бути"
"у форматі UNC (\\servername\resource)'"),
					,
...
"Введите другое имя файла.';uk='Файл ""%1"" уже існує."
"Введіть інше ім''я файлу.'"),
				ПолноеИмяФайловойБазы),
			,
			"ПолноеИмяФайловойБазыWindows");
		Возврат Ложь;
...
"""%1"""
"произошла ошибка:"
"""%2"".';uk='Під час регламентного витягування тексту з файлу"
"""%1"""
"відбулася помилка:"
"""%2"".'"),
					ИмяСРасширениемФайла,
