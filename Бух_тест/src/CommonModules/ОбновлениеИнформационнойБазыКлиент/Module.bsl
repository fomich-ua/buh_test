...
"можно использовать только совместно с параметром ЗапуститьОбновлениеИнформационнойБазы.';uk='Параметр запуску ЗарегистрироватьПолноеИзменениеИОМДляПодчиненныхУзловРИБ"
"можна використовувати тільки разом з параметром ЗапуститьОбновлениеИнформационнойБазы.'"));
	КонецЕсли;
