...
Функция ПолучитьТипыМоделиДанныхОбласти()
	...
	Для Каждого ЭлементМоделиДанных Из МодельДанных Цикл
		...
		Если Не ВыгрузкаЗагрузкаДанныхСлужебный.ЭтоРегламентноеЗадание(ОбъектМетаданных)
				И Не ВыгрузкаЗагрузкаДанныхСлужебный.ЭтоЖурналДокументов(ОбъектМетаданных) Тогда
