...
""
"Пользователей информационной базы следует создавать в режиме 1С:Предприятия.';uk='Виявлено, що користувач інформаційної бази"
"з роллю ""Повні права"" був створений у Конфігураторі:"
""
"- користувач не знайдений у довіднику Користувачі,"
"- користувач зареєстрований у довіднику Користувачі,"
"- користувач доданий у групу доступу Адміністратори."
""
"Користувачів інформаційної бази варто створювати в режимі 1С:Підприємства.'");
...
"в группу доступа Администраторы.';uk='Недостатньо прав для додавання користувача ""%1"""
"в групу доступу Адміністратори.'"),
					...
					Иначе
						...
						Для каждого Профиль Из Профили Цикл
							ЗаписьЖурналаРегистрации(
								НСтр("ru='Управление доступом.Роль не найдена в метаданных';uk='Управління доступом. Роль не знайдена в метаданих'",
...
"не найдена в метаданных.';uk='При оновленні ролей користувача ""%1"""
"роль ""%2"""
...
"которому разрешен вход в программу.';uk='У групі доступу Адміністратори"
...
Процедура ЗаполнениеДанныхДляОграниченияДоступа(КоличествоДанных = 0, ТолькоКэшРеквизиты = Ложь, ЕстьИзменения = Неопределено) Экспорт
	...
	Если КоличествоДанных < 10000 Тогда
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Управление доступом.Заполнение данных для ограничения доступа';uk='Управління доступом.Заповнення даних для обмеження доступу'",
				 ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
"У объекта типа ""%1"""
"не найдена табличная часть ""Наборы значений доступа"".';uk='Невірні параметри."
"У об''єкта типу ""%1"""
...
"""Записать наборы значений доступа"".';uk='Невірні параметри."
"Тип об''єкта ""%1"""
...
"не задан тип ""%1"".';uk='Помилка при записі наборів значень доступу:"
...
"Тип объекта ""%1"""
"не найден в подписках на события"
"""Заполнить наборы значений доступа табличных частей"".';uk='Невірні параметри."
"Тип об''єкта ""%1"""
"не знайдений в підписках на події"
...
"""Записать зависимые наборы значений доступа"".';uk='Невірні параметри."
"Тип об''єкта ""%1"""
...
"""%1"".';uk='Помилка при виконанні процедури УправлениеДоступом.УстановитьУсловиеОтбораВЗапросе()."
""
...
""
"Наверный параметр ОписаниеОбъектаМетаданных.';uk='Помилка у функції ПустаяСсылкаОбъектаМетаданных"
...
"""%1"".';uk='Помилка у функції ПустаяСсылкаОбъектаМетаданных"
"загального модуля УправлениеДоступомСлужебный."
""
...
""
"В тексте запроса не найдена строка ""&ПодстановкаПоляВидИзмененияСтроки"".';uk='Помилка в значенні параметра ТекстЗапросаВыбораСтарых"
...
"процедуры ТекстЗапросаВыбораИзменений модуля УправлениеДоступомСлужебный."
""
"В тексте запроса не найдена строка ""&ПодстановкаПоляВидИзмененияСтроки"".';uk='Помилка в значенні параметра ТекстЗапросаВыбораНовых"
"процедури ТекстЗапросаВыбораИзменений модуля УправлениеДоступомСлужебный."
""
"У тексті запиту не знайдений рядок ""&ПодстановкаПоляВидИзмененияСтроки"".'");
	КонецЕсли;
...
"""%1"" возникла ошибка:"
""
"%2';uk='При оновленні залежного набору значень доступу об''єкта"
"""%1"" виникла помилка:"
""
"%2'"),
...
""
"Операция может быть выполнена только интерактивно.';uk='Для зміни адміністративного доступу"
...
""
"Допустимо только 2 значения: ""1"" и ""-1"".';uk='Помилка в процедурі ОбновитьНаборыЗаписей"
"загального модуля УправлениеДоступомСлужебный."
""
...
"в значении параметра НовыеЗаписи.';uk='Помилка в процедурі ОбновитьНаборыЗаписей"
"загального модуля УправлениеДоступомСлужебный."
""
