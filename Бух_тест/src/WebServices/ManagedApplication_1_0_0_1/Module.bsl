...
Функция ПолучитьТребуемыеРазрешенияНаИспользованиеВнешнихРесурсов(ИнформацияОбОшибке)
	...
	Попытка
		...
		Возврат Обработки.НастройкаРазрешенийНаИспользованиеВнешнихРесурсовВМоделиСервиса.СериализоватьЗапросыНаИспользованиеВнешнихРесурсовПриВключенииПрофилейЮезопасности();
