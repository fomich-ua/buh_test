...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КлючСтраны = Параметры.КлючСтраны;
...
Процедура КомандаОК(Команда)
	...
	Если Модифицированность Тогда
		Результат = Новый Структура("Код, Представление, НаселенныйПунктДетально", 
			...
			УправлениеКонтактнойИнформациейКлиент.НаименованиеНаселенногоПунктаПоЧастямАдреса(ЧастиАдреса, КлючСтраны),
			ЧастиАдреса);
		...
		Если МожноЗагружатьКлассификатор И РегионНеЗагружен Тогда
			...
			УправлениеКонтактнойИнформациейКлиент.ПредложениеЗагрузкиКлассификатора(
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Данные для ""%1"" не загружены.';uk='Дані для ""%1"" не завантажені.'"), ВыбранноеЗначение.Представление));
		КонецЕсли;
