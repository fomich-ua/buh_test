...
Процедура УдалитьВременныйКаталогСообщенийОбмена(ИмяВременногоКаталога)
	...
	Если Не ПустаяСтрока(ИмяВременногоКаталога) Тогда
		...
		Исключение
			СтрокаСообщения = НСтр("ru='Ошибка при попытке удаления файлов из временного каталога сообщений обмена %1. Описание ошибки: %2';uk='Помилка при спробі вилучення файлів з тимчасового каталогу повідомлень обміну %1. Опис помилки: %2'",
