...
"При загрузке данных будут созданы дубли несопоставленных объектов. Продолжить?';uk=""Є незіставлені об'єкти."
...
"Перейти в журнал регистрации?';uk='При завантаженні даних виникли помилки."
...
Процедура ПрочитатьСообщенияПользователю()
	...
	Если Найти(ТекстСообщения, "{ВыполненПереходНаНовыйОбмен}") Тогда
