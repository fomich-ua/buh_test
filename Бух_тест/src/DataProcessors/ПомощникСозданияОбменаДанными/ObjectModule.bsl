...
"Возможно, информационная база не является подчиненным узлом в РИБ.';uk='Головний вузол для поточної інформаційної бази не визначений."
...
"Настройку обмена требуется начать заново.';uk='На першому етапі настройки обміну був неправильно зазначений префікс другої інформаційної бази."
