...
"выполняется только администраторами.';uk='Недостатньо прав доступу."
""
...
"Процедура запущена в фоновом задании %2';uk='%1."
...
"  уже выполняется в фоновом задании ""%2"", начатом %3.';uk='Процедура регламентного задачі ""%1"""
...
"возможно потребуется обновить данные вручную.';uk='Завдання скасоване, але стан скасування буде"
...
Процедура СообщитьОбОкончанииРучногоВыполненияРегламентногоЗадания()
	...
	Для каждого Оповещение Из ОповещенияОбОкончанииВыполнения Цикл
		...
		ПоказатьОповещениеПользователя(
			...
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='%1."
"Процедура завершена в фоновом задании %2';uk='%1."
