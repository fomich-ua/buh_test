...
"""Информация"" на рабочем столе, команда ""Описание изменений программы"".';uk='Хід обробки дані версії програми можна також проконтролювати з розділі"
...
"Работа с этими данными временно ограничена';uk='Виконуються додаткові процедури обробки даних на версію %1"
...
Функция СообщениеОРезультатахОбновления(СведенияОбОбновлении)
	...
	Если ВсегоОбработчиков = УспешноВыполненоОбработчиков Тогда
		...
		Иначе
			ТекстСообщения = НСтр("ru='Все процедуры обновления выполнены успешно (%1)';uk='Всі процедури оновлення виконані успішно (%1)'");
		КонецЕсли;
		Элементы.КартинкаИнформация1.Картинка = БиблиотекаКартинок.Успешно32;
	Иначе
		ТекстСообщения = НСтр("ru='Не все процедуры удалось выполнить (выполнено %1 из %2)';uk='Не всі процедури вдалося виконати (виконане %1 з %2)'");
