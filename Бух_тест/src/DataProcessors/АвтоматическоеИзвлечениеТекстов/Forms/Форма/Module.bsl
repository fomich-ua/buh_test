...
Процедура ИнтервалВремениВыполненияПриИзменении(Элемент)
	...
	Если ВключеноИзвлечениеТекста Тогда
		...
		// Здесь ТекущаяДата не выводится и не пишется в базу, а используется только
		// на клиенте в информационных целях, поэтому заменять на ТекущаяДатаСеанса не надо.
...
""
"Обработано файлов: %1.';uk='Завершене витягування тексту з"
...
"произошла неизвестная ошибка.';uk='Під час витягування тексту з файлу ""%1"""
...
"Обработано файлов: %1';uk='Витягування тексту завершене."
"Оброблено файлів: %1'"),
