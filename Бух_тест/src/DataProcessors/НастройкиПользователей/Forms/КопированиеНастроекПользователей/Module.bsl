...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ВРег(ИмяСобытия) = ВРег("ВыборНастроек") Тогда
		...
		Если КоличествоНастроек = 0 Тогда
			ТекстЗаголовка = НСтр("ru='Выбрать';uk='Вибрати'");
...
Процедура ПользовательНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПараметрыОтбора = Новый Структура(
		"СкрытьПользователейБезПользователяИБ, РежимВыбора, СкрываемыеПользователи",
...
"выберите другого пользователя.';uk='Не можна копіювати настройки користувача самому собі,"
"виберіть іншого користувача.'"));
	...
	Элементы.ВыбратьНастройки.Заголовок = НСтр("ru='Выбрать';uk='Вибрати'");
...
&НаКлиенте
Процедура СкопироватьНастройкиПоказатьВопрос(Ответ, Отчет)
