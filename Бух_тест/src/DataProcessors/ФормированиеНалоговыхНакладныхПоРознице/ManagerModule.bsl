...
Функция ПолучитьДанныеДляДокументовП2(Запрос)
	...
	|			И (ВЫБОР
	|				КОГДА НоменклатурныйСостав.СтавкаНДС В (ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС0), ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС7), ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС20))
