...
&НаСервере
Функция НачатьОбработкуЗапросов(Знач Запросы, Знач РежимПроверкиПрименения)
	
	ПоместитьВоВременноеХранилище(Неопределено, АдресХранилища);
	
	Если РежимПроверкиПрименения Тогда
		
		ПараметрыЗадания = Новый Массив();
		ПараметрыЗадания.Добавить(АдресХранилища);
		
		ПараметрыВызоваМетода = Новый Массив();
		ПараметрыВызоваМетода.Добавить("Обработки.НастройкаРазрешенийНаИспользованиеВнешнихРесурсовВМоделиСервиса.ВыполнитьОбработкуЗапросовПроверкиПрименения");
	...
	Иначе
		...
		ПараметрыВызоваМетода = Новый Массив();
		ПараметрыВызоваМетода.Добавить("Обработки.НастройкаРазрешенийНаИспользованиеВнешнихРесурсовВМоделиСервиса.ВыполнитьОбработкуЗапросов");
		ПараметрыВызоваМетода.Добавить(ПараметрыЗадания);
