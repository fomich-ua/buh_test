...
Процедура ОбщаяФормаНастройкиЭП(Команда)
	...
	СвойстваФормыДляОткрытия = Новый Структура();
	СвойстваФормыДляОткрытия.Вставить("ИмяФормыДляОткрытия", "ОбщаяФорма.НастройкиКриптографии");
	СвойстваФормыДляОткрытия.Вставить("ПараметрыФормы", Новый Структура);
	
	ОткрытьФорму(СвойстваФормыДляОткрытия.ИмяФормыДляОткрытия,, ЭтаФорма);
