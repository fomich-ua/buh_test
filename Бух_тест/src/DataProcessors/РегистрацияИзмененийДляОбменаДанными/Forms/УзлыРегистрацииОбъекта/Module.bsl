...
"на узлах?';uk='Змінити реєстрацію ""%1"""
"на вузлах?'");
...
Процедура ИзменитьРегистрациюЗавершение(Знач РезультатВопроса, Знач ДополнительныеПараметры) Экспорт
	...
	Если Колво > 0 Тогда
		Текст = НСтр("ru='Регистрация %1 была изменена на %2 узлах';uk='Реєстрація %1 була змінена на %2 вузлах'");
		ЗаголовокОповещения = НСтр("ru='Изменение регистрации:';uk='Зміна реєстрації:'");
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='ДеревоУзловОбменаНомерСообщения';uk='ДеревоУзловОбменаНомерСообщения'"));
