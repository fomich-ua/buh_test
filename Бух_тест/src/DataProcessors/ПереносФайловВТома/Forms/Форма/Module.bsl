...
""
"Эта операция может занять продолжительное время.';uk='Виконати перенесення файлів в інформаційній базі в тома зберігання файлів?"
""
...
"Перенесено файлов: %1';uk='Завершене перенесення файлів в тома."
"Перенесено файлів: %1'"),
			ЧислоПеренесенных);
...
"Перенос прерван.';uk='Не вдалося перенести жодного файлу з пакету."
...
Функция ПеренестиВерсиюВТом(ВерсияСтруктура, МаксимальныйРазмерФайла, МассивФайловСОшибками)
	...
	Если Размер > МаксимальныйРазмерФайла Тогда
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Файлы.Ошибка переноса файла в том';uk='Файли.Помилка перенесення файлу в том'",
...
"""%1"""
"возникла ошибка:"
"""Размер превышает максимальный"".';uk='При перенесенні в том файлу"
"""%1"""
"виникла помилка:"
"""Розмір перевищує максимальний"".'"),
	...
	ИмяДляЖурнала = ВерсияСтруктура.Текст;
	ЗаписьЖурналаРегистрации(
		НСтр("ru='Файлы.Начат перенос файла в том';uk='Файли.Розпочато переміщення файлу в том'",
		     ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
		УровеньЖурналаРегистрации.Информация,
		,
		ФайлСсылка,
...
"""%1"".';uk='Почато перенесення в том файлу"
"""%1"".'"),
			ИмяДляЖурнала));
	...
	Попытка
		...
		ХранилищеФайла =
			РаботаСФайламиСлужебныйВызовСервера.ПолучитьХранилищеФайлаИзИнформационнойБазы(
				ВерсияСсылка);
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Файлы.Завершен перенос файла в том';uk='Файли.Завершено перенесення файлу у том'",
			     ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Информация,
			,
			ФайлСсылка,
...
"""%1"".';uk='Завершене перенесення в том файлу"
"""%1"".'"),
				ИмяДляЖурнала));
...
"""%1"""
"возникла ошибка:"
"""%2"".';uk='При перенесенні в том файлу"
"""%1"""
"виникла помилка:"
"""%2"".'"),
				ИмяДляЖурнала,
