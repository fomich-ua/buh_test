...
Процедура Конвертация_ПередЗагрузкойДанных(ФайлОбмена, Отказ) Экспорт
	...
	Если Константы.ВыполнятьСинхронизациюV77.Получить() Тогда
		Параметры.ТаблицаСоответствийДокументов = Новый ТаблицаЗначений;
		Параметры.ТаблицаСоответствийДокументов.Колонки.Добавить("Документ77");
		Параметры.ТаблицаСоответствийДокументов.Колонки.Добавить("Объект");
		Параметры.ТаблицаСоответствийДокументов.Колонки.Добавить("ПредставлениеОбъекта");
	КонецЕсли;
...
Процедура Конвертация_ПослеЗагрузкиДанных() Экспорт
	...
	Если Константы.ВыполнятьСинхронизациюV77.Получить() Тогда
		АдресТаблицыСоответствий = ПоместитьВоВременноеХранилище(Параметры.ТаблицаСоответствийДокументов);
		Параметры.АдресТаблицыСоответствийДокументов = АдресТаблицыСоответствий;
	КонецЕсли;
