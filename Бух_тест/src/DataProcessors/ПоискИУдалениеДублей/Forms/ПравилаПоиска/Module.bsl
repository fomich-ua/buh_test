...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтрЗаменить( НСтр("ru='Правила поиска дублей ""%1""';uk='Правила пошуку дублів ""%1""'"), "%1", Параметры.ПредставлениеОбластиОтбора);
...
Процедура УчитыватьПрикладныеПравилаПриИзменении(Элемент)
	...
	ТекстЗаголовка = НСтр("ru='Предупреждение';uk='Попередження'");
...
""
"Отключить использование поставляемых ограничений?';uk='Увага: пошук і вилучення дублів елементів без урахування обмежень, що поставляються,"
"може привести до неузгодженості даних у програмі."
""
"Відключити використання обмежень, що поставляються?'");
...
Функция ОшибкиВыбора() 
	...
	Возврат НСтр("ru='Необходимо указать хотя бы одно правило поиска дублей.';uk='Необхідно вказати хоча б одне правило пошуку дублів.'");
КонецФункции
