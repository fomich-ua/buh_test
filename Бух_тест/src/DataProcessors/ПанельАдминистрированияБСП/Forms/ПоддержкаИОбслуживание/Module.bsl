...
Процедура ОбновитьНастройкиОбновленияКонфигурации()
	...
	ЗаголовокОбновленияПрограммы = НСтр("ru='Автоматическая проверка обновлений отключена.';uk='Автоматична перевірка оновлень відключена.'");
	Если НастройкиОбновленияКонфигурации.ПроверятьНаличиеОбновленияПриЗапуске = 2 Тогда
		ЗаголовокОбновленияПрограммы = НСтр("ru='Автоматическая проверка обновлений выполняется при каждом запуске программы.';uk='Автоматична перевірка оновлень виконується при кожному запуску програми.'");
	ИначеЕсли НастройкиОбновленияКонфигурации.ПроверятьНаличиеОбновленияПриЗапуске = 1 Тогда
		ЗаголовокОбновленияПрограммы = НСтр("ru='Автоматическая проверка обновлений выполняется по расписанию: %1.';uk='Автоматична перевірка оновлень виконується за розкладом: %1.'");
