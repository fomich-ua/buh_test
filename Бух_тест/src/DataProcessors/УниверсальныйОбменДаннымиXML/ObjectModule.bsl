		...
		Если АлгоритмыОбработчика.Количество() <> 0 Тогда //В этой строке есть вызовы алгоритмов
			...
			Для Каждого Алгоритм Из АлгоритмыОбработчика Цикл
				...
				Если МассивЗапрошенныхЭлементов.Найти(ВРег(Алгоритм)) <> Неопределено Тогда //Рекурсивный вызов алгоритма
					...
					СтрокаОператора = "ВызватьИсключение ""РЕКУРСИВНЫЙ ВЫЗОВ АЛГОРИТМА: %1"";";
...
"и повторите выгрузку.';uk='Код алгоритмів не може бути інтегрований в обробник через виявлений рекурсивний виклик алгоритмів. "
...
"%1';uk=""При спробі з'єднання з COM-сервером виникла наступна помилка:"
"%1""");
...
//
// Пример:
//  ПодставитьПараметрыВСтроку(Н Стр("ru='%1 пошел в %2';uk='%1 пішов в %2'"), "Вася", "Зоопарк") = "Вася пошел в Зоопарк".
//
