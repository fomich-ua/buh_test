...
"в справочнике найдены не уникальные записи.';uk=""Перед завантаженням ідентифікаторів об'єктів метаданих"
"у довіднику не знайдені унікальні записи."""));
			...
			Если Отказ Тогда
				ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Загрузка важных изменений не выполнена."
"При загрузке предопределенных элементов найдены не уникальные записи."
"По следующим причинам продолжение невозможно."
"%1';uk='Завантаження важливих змін не виконане."
"При завантаженні напередвизначених елементів знайдені не унікальні записи."
...
"%1'"),
			...
			Если ЗначениеЗаполнено(ДублиПредопределенных) Тогда
				ЗаписьЖурналаРегистрации(
					НСтр("ru='Предопределенные элементы.Найдены не уникальные записи.';uk='Напередвизначені елементи.Знайдені не унікальні записи.'",
...
"%1';uk='При завантаженні напередвизначених елементів знайдені не унікальні записи."
"%1'"),
						ДублиПредопределенных));
			КонецЕсли;
...
"   - нажмите Выполнить."
"3. После этого запустите 1С:Предприятие и выполните повторную синхронизацию данных.';uk='Завантаження важливих змін не виконане."
"%1"
"Потрібне виправлення інформаційної бази."
"1. Відкрийте конфігуратор, перейдіть в меню Адміністрування,"
"   виберіть пункт ""Тестування і виправлення ...""."
"2. У формі, що відкрилась"
...
"   - натисніть Виконати."
"3. Після цього запустіть 1С:Підприємство і виконайте повторну синхронізацію даних.'");
КонецФункции
