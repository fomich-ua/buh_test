...
Процедура ВыполнитьСтандартноеСопоставлениеСсылок(ПотокЗаменыСсылок, Знач ОбъектМетаданных, Знач ТаблицаИсходныхСсылок, Знач ИмяКолонкиИсходнойСсылки) Экспорт
