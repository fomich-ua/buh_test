...
"Пожалуйста, повторите попытку позже';uk='Сервіс по відображенню звернень в техпідтримку тимчасово недоступний."
...
Функция ПолучитьШаблонДиапазона(Диапазон)
	...
	Шаблон = "%1 - %2";
	Шаблон = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Шаблон, Диапазон.Начало, Диапазон.Конец);
