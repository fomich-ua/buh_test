...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		ВызватьИсключение НСтр("ru='Неизвестный тип вводимых данных.';uk='Невідомий тип даних, що вводяться.'");
...
Процедура СброситьРазмерыИПоложениеОкна()
	...
	Если ПравоДоступа("СохранениеДанныхПользователя", Метаданные) Тогда
		...
		ХранилищеСистемныхНастроек.Удалить("Обработка.ИнтернетПоддержкаПользователей.Форма.ВводДанных",
			"",
			ИмяПользователя);
	КонецЕсли;
