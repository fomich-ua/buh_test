...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.НадписьЛогина.Заголовок = НСтр("ru='Логин: ';uk='Логін: '")
		+ Параметры.login;
...
Процедура ПриОткрытии(Отказ)
	...
	// В дельнейшем контекст регистрации не используется
...
Процедура АдресНажатие(Элемент, СтандартнаяОбработка)
	...
	ИмяФормыАдреса = КонтекстВзаимодействия.ПутьКФормам + "ПочтовыйАдрес";
...
Процедура ПояснениеКЗаголовкуОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылка, СтандартнаяОбработка)
	...
	Если НавигационнаяСсылка = "TechSupport" Тогда
		...
		ПараметрыСообщения.Вставить("ТипСообщения"                 , 4);
		ПараметрыСообщения.Вставить("НазваниеОрганизации"          , НазваниеОрганизации);
		ПараметрыСообщения.Вставить("ТипОсновнойДеятельности"      , ТипДеятельности);
		ПараметрыСообщения.Вставить("ИНН"                          , ИНН);
		ПараметрыСообщения.Вставить("КПП"                          , КПП);
		ПараметрыСообщения.Вставить("РуководительОрганизации"      , Руководитель);
		ПараметрыСообщения.Вставить("Телефон"                      , Телефон);
		ПараметрыСообщения.Вставить("АдресЭлектроннойПочты"        , АдресЭлектроннойПочты);
		ПараметрыСообщения.Вставить("Факс"                         , Факс);
		ПараметрыСообщения.Вставить("ПредставлениеАдреса"          , ПредставлениеАдреса);
		ПараметрыСообщения.Вставить("ГдеПриобретенаПрограмма"      , ГдеПриобретенаПрограмма);
		ПараметрыСообщения.Вставить("ДатаПриобретения"             , ДатаПриобретенияПрограммы);
		ПараметрыСообщения.Вставить("ЧислоРабочихМест"             , ЧислоРабочихМест);
		ПараметрыСообщения.Вставить("ОтветственныйЗаРаботуСПакетом", Ответственный);
...
Функция XMLСтрокаЗначения(Знач Значение) Экспорт
