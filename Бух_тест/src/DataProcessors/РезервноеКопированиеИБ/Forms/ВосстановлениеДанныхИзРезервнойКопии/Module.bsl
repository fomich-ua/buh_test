...
"Информационная база разблокирована.';uk='Не вдалося примусово відключити сеанси:"
""
"%1."
""
"Підготовка до відновлення даних з резервної копії скасована."
"Інформаційна база розблокована.'"), ИменаАктивныхСеансов);
