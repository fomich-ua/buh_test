...
"%1';uk='Є активні сеанси роботи з програмою,"
...
"%1."
"Подготовка к резервному копированию отменена. Информационная база разблокирована.';uk='Не вдалося примусово відключити сеанси:"
" %1."
"Підготовка до резервного копіювання скасована. Інформаційна база розблокована.'"), ИменаАктивныхСеансов);
