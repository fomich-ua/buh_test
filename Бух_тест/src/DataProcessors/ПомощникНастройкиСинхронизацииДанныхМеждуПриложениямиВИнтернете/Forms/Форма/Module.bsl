...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Настройка синхронизации данных с ""%1""';uk='Настройка синхронізації даних з ""%1""'"), НаименованиеКорреспондента);
	Элементы.ОписаниеСинхронизацииДанных.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Описание синхронизации данных с ""%1""';uk='Опис синхронізації даних з ""%1""'"), НаименованиеКорреспондента);
...
Процедура УстановитьТекстРезервногоКопирования()
	...
	Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Перед настройкой синхронизации рекомендуется сделать <a href=%1>резервную копию данных</a>.';uk='Перед настроюванням синхронізації рекомендується зробити <a href=%1>резервну копію даних</a>.'"),
		Вариант);
