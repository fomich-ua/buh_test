...
//
&НаСервереБезКонтекста
Функция ПолучитьМассивСпособовАмортизацииНУ(СчетУчетаБУ, СпособНачисленияАмортизацииБУ) Экспорт
...
Процедура СчетУчетаБУПриИзменении(Элемент)
	...
	МассивСпособовНачисленияАмортизацииНУ = ПолучитьМассивСпособовАмортизацииНУ(СчетУчетаБУ, СпособНачисленияАмортизацииБУ);
...
Процедура СпособНачисленияАмортизацииБУПриИзменении(Элемент)
	...
	Элементы.СпособНачисленияАмортизацииНУ.СписокВыбора.ЗагрузитьЗначения(ПолучитьМассивСпособовАмортизацииНУ(СчетУчетаБУ, СпособНачисленияАмортизацииБУ));
