...
Процедура ДвижениеПоВзаиморасчетам()
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ИЗ
	               |	РегистрНакопления.ВзаиморасчетыССотрудниками.Остатки(&Дата, Организация = &Организация И ФизическоеЛицо = &ФизическоеЛицо) КАК ВзаиморасчетыССотрудниками
	               |
	               |ГДЕ
...
Процедура ЗаполнитьПоДокументуОснованию(Основание)
	...
	ИначеЕсли ВидДокументаОснования = Тип("ДокументСсылка.ВозвратТоваровПоставщику") Тогда
