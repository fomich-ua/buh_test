...
Функция ПечатьНА3(МассивОбъектов, ОбъектыПечати, ПараметрыПечати, ИмяМакета)
	...
	Макет = УправлениеПечатью.ПолучитьМакет("ОбщийМакет.ПФ_MXL_НА3");
	...
	Для Каждого Ссылка Из МассивОбъектов Цикл	
		...
		Пока Выборка.Следующий() Цикл
			...
			Параметры.ФИОРук      = ФизическиеЛица.ФамилияИнициалыФизЛица(Выборка.ФИОРук);
			Параметры.ФИОБух      = ФизическиеЛица.ФамилияИнициалыФизЛица(Выборка.ФИОБух);
...
Функция ПечатьНакладной(МассивОбъектов, ОбъектыПечати, ПараметрыВывода, ИмяМакета)
	...
	Макет = УправлениеПечатью.ПолучитьМакет("Документ.ПередачаНМА.ПФ_MXL_Накладная");
