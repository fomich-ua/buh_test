...
Процедура ЗаполнитьПоДокументуОснованию(Основание)
	...
	Если НЕ ТипДокументаОснования = ТипДокументаПокупкаПродажаВалюты тогда
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ВидОперации = Перечисления.ВидыОперацийПоступлениеДенежныхСредств.ПоступлениеСредствОтФСС Тогда
...
Функция ПолучитьЗапросДляДвиженийПоРасчетамФСС(СтруктураШапкиДокумента)
	Запрос = Новый Запрос;
