...
Функция ПечатьБухгалтерскаяСправка(МассивОбъектов, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Макет = УправлениеПечатью.ПолучитьМакет("Документ.ОперацияБух.ПФ_MXL_БухгалтерскаяСправка");
	...
	Для каждого Ссылка Из МассивОбъектов Цикл	
		...
		ПодвалДокумента.Параметры.РасшифровкаПодписиИсполнителя = ?(НЕ ЗначениеЗаполнено(Док.Ответственный), "", ФизическиеЛица.ФамилияИнициалыФизЛица(Док.Ответственный.ФизЛицо));
