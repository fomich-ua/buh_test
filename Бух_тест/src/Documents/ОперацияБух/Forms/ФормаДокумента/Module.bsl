...
Процедура ОбработатьИзменениеСчета(Форма, ДтКт)
	...
	ПоляОбъекта = Новый Структура("Субконто1,Субконто2,Субконто3,НалоговыйУчет,УчетПоНалоговымНазначениямНДС,УчетСуммНУ,Валютный,Количественный,Организация");
...
Процедура ЗаполнитьДобавленныеКолонкиТаблиц()
	...
	ПоляОбъектаДт = Новый Структура(
		"Субконто1, Субконто2, Субконто3, НалоговыйУчет, УчетПоНалоговымНазначениямНДС, УчетСуммНУ, Валютный, Количественный",
		"СубконтоДт1", "СубконтоДт2", "СубконтоДт3", "НалоговыйУчетДт", "УчетПоНалоговымНазначениямНДСДт", "УчетСуммНУДт", "ВалютныйДт", "КоличественныйДт");
		
	ПоляОбъектаКт = Новый Структура(
		"Субконто1, Субконто2, Субконто3, НалоговыйУчет, УчетПоНалоговымНазначениямНДС, УчетСуммНУ, Валютный, Количественный",
		"СубконтоКт1", "СубконтоКт2", "СубконтоКт3", "НалоговыйУчетКт", "УчетПоНалоговымНазначениямНДСКт", "УчетСуммНУКт", "ВалютныйКт", "КоличественныйКт");
