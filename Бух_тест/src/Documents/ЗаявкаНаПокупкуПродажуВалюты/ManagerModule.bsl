...
Процедура ПечатьПокупка(ДанныеДляПечати, ТабличныйДокумент)
	...
	Макет = УправлениеПечатью.ПолучитьМакет("Документ.ЗаявкаНаПокупкуПродажуВалюты.ПФ_MXL_ЗаявкаНаПокупку");
...
Процедура ПечатьПродажа(ДанныеДляПечати, ТабличныйДокумент)
	...
	Макет = УправлениеПечатью.ПолучитьМакет("Документ.ЗаявкаНаПокупкуПродажуВалюты.ПФ_MXL_ЗаявкаНаПродажу");
	Обл   = Макет.ПолучитьОбласть("Шапка");
