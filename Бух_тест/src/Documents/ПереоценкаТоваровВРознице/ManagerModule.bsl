...
Функция ПечатьПереоценкиТоваровВРознице(МассивОбъектов, ОбъектыПечати, ПараметрыВывода)
	...
	|	ПереоценкаТоваровВНТТ.Ответственный.ФизЛицо.Наименование КАК Отпустил,
	...
	Пока Шапка.Следующий() Цикл
		...
		НомерСтрокиНачало = ТабличныйДокумент.ВысотаТаблицы + 1;
  		...
  		Макет = УправлениеПечатью.ПолучитьМакет("Документ.ПереоценкаТоваровВРознице.ПФ_MXL_ПереоценкаТоваровВРознице");
