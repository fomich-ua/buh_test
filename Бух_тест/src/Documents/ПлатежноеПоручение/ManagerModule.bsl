...
Процедура ПечатьПлатежногоПорученияВГрн(Выборка, ТабличныйДокумент)
	...
	Макет = УправлениеПечатью.ПолучитьМакет("ОбщийМакет.ПФ_MXL_ПлатежноеПоручение");
...
Процедура ПечатьПлатежногоПорученияВВалюте(Выборка, ТабличныйДокумент)
	...
	Макет = УправлениеПечатью.ПолучитьМакет("ОбщийМакет.ПФ_MXL_ПлатежноеПоручениеВВалюте");
	Обл   = Макет.ПолучитьОбласть("Шапка");
