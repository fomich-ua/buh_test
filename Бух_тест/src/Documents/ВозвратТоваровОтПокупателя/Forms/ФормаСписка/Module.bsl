...
Функция ВернутьПараметрыОткрытия()
	Возврат Новый Структура("Ключ, Заголовок, Период", Список, НСтр("ru='Реестр документов ""Возврат товаров от покупателя""';uk='Реєстр документів ""Повернення товарів від покупця""'"), Элементы.Список.Период);
КонецФункции
