...
"Данное действие можно осуществить запустив 1С:Предприятие в режиме ""Толстый клиент (обычное приложение)""! "
"Запустите 1С:Предприятие в указанном режиме и повторите попытку.';uk='Ви намагаєтеся відкрити архівний регламентований звіт, створений у попередній редакції конфігурації ЗОВНІШНІМ (підключеним) звітом."
"Дану дію можна виконати запустивши 1С:Підприємство в режимі ""Товстий клієнт (звичайний додаток)""! "
"Запустіть 1С:Підприємство в зазначеному режимі і повторіть спробу.'");
								ПоказатьПредупреждение(, ТекстПредупреждения, 5 );
								Возврат;
							#Иначе
...
"Данное действие можно осуществить запустив 1С:Предприятие в режиме ""Толстый клиент (управляемое приложение)""! "
"Запустите 1С:Предприятие в указанном режиме и повторите попытку.';uk='Ви намагаєтеся відкрити архівний регламентований звіт, створений у попередній редакції конфігурації."
"Дану дію можна виконати запустивши 1С:Підприємство в режимі ""Товстий клієнт (керований додаток)""! "
"Запустіть 1С:Підприємство в зазначеному режимі і повторіть спробу.'");
						ПоказатьПредупреждение(, ТекстПредупреждения, 5 );
						Возврат;
					#КонецЕсли
