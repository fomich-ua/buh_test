...
Функция ВернутьПараметрыОткрытия()
	Возврат Новый Структура("Ключ, Заголовок, Период", Список, НСтр("ru='Реестр документов ""Возврат товаров поставщику""';uk='Реєстр документів ""Повернення товарів постачальнику""'"), Элементы.Список.Период);
КонецФункции
