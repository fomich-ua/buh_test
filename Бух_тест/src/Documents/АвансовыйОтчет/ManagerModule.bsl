...
Функция ПечатьАвансовогоОтчета(МассивОбъектов, ОбъектыПечати, ИмяМакета)
	...
	МакетАО          = УправлениеПечатью.ПолучитьМакет("Документ.АвансовыйОтчет.ПФ_MXL_АвансовыйОтчет");
	МакетАО_01012011 = УправлениеПечатью.ПолучитьМакет("Документ.АвансовыйОтчет.ПФ_MXL_АвансовыйОтчет01012011");
	МакетАО_25012013 = УправлениеПечатью.ПолучитьМакет("Документ.АвансовыйОтчет.ПФ_MXL_АвансовыйОтчет25012013");
	МакетАО_04022014 = УправлениеПечатью.ПолучитьМакет("Документ.АвансовыйОтчет.ПФ_MXL_АвансовыйОтчет04022014");
	МакетАО_06112015 = УправлениеПечатью.ПолучитьМакет("Документ.АвансовыйОтчет.ПФ_MXL_АвансовыйОтчет06112015");
	МакетАО_19042016 = УправлениеПечатью.ПолучитьМакет("Документ.АвансовыйОтчет.ПФ_MXL_АвансовыйОтчет19042016");
	...
	Если ИспользованоМакетов = 1 Тогда
		Если КоличествоАО > 0 Тогда 
			ИмяМакета = "Документ.АвансовыйОтчет.ПФ_MXL_АвансовыйОтчет";
		ИначеЕсли КоличествоАО_01012011 > 0  Тогда
			ИмяМакета = "Документ.АвансовыйОтчет.ПФ_MXL_АвансовыйОтчет01012011";
		ИначеЕсли КоличествоАО_25012013 > 0 Тогда 
			ИмяМакета = "Документ.АвансовыйОтчет.ПФ_MXL_АвансовыйОтчет25012013";
		ИначеЕсли КоличествоАО_04022014 > 0 Тогда 
			ИмяМакета = "Документ.АвансовыйОтчет.ПФ_MXL_АвансовыйОтчет04022014";
		ИначеЕсли КоличествоАО_06112015 > 0 Тогда 
			ИмяМакета = "Документ.АвансовыйОтчет.ПФ_MXL_АвансовыйОтчет06112015";
		ИначеЕсли КоличествоАО_19042016 > 0 Тогда 
			ИмяМакета = "Документ.АвансовыйОтчет.ПФ_MXL_АвансовыйОтчет19042016";
		КонецЕсли;
	КонецЕсли;  
