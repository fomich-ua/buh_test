...
Функция ПечатьОЗ1(МассивОбъектов, ОбъектыПечати, ПараметрыПечати, ИмяМакета)
	...
	Макет = УправлениеПечатью.ПолучитьМакет("ОбщийМакет.ПФ_MXL_ОЗ1");
...
Функция ПечатьМШ7(МассивОбъектов, ОбъектыПечати, ПараметрыПечати, ИмяМакета, Сдача)
	...
	Макет = УправлениеПечатью.ПолучитьМакет("ОбщийМакет.ПФ_MXL_МШ7");
	...
	Для Каждого Ссылка Из МассивОбъектов Цикл	
		...
		|		Док.НазначениеИспользованияНовое.СчетБУДляПечати       КАК СчетПередачиБУ,
		...
		|		Док.НазначениеИспользованияНовое.СчетБУДляПечати,
