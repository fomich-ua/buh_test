...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru='Распределенная информационная база с фильтром по организации';uk='Розподілена інформаційна база з фільтром з організації'");
...
"Необходимо указать ограничения миграции данных по организациям.';uk='Розподілена інформаційна база являє собою ієрархічну структуру, що складається з окремих інформаційних "
