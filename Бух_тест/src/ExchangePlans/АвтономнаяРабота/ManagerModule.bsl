...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат НСтр("ru='Настройки обмена автономного рабочего места';uk='Настройки обміну автономного робочого місця'");
...
Функция ОписаниеОграниченийПередачиДанных(НастройкаОтборовНаУзле, ВерсияКорреспондента, ИдентификаторНастройки = "") Экспорт
	...
	Если НастройкаОтборовНаУзле.ИспользоватьОтборПоОрганизациям Тогда
		...
		Возврат НСтр("ru='В автономном рабочем месте доступна только часть данных.';uk='В автономному робочому місці доступна лише частина даних.'");
		
	Иначе
		
		Возврат НСтр("ru='В автономном рабочем месте доступны все данные.';uk='В автономному робочому місці доступні всі дані.'");
