...
"на данной платформе не поддерживается.';uk='Створення початкового образу файлової інформаційної бази"
"на цій платформі не підтримується.'");
	...
	ПоказатьПредупреждение(Обработчик, НСтр("ru='Создание начального образа успешно завершено.';uk='Створення початкового образу успішно завершене.'"));
КонецПроцедуры
