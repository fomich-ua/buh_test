...
&НаКлиенте
Процедура ИзменитьРасписаниеСинхронизацииДанныхЗавершение(Расписание, ДополнительныеПараметры)
...
Процедура ОбновитьВидимостьНаСервере()
	...
	РольДоступнаНастройкаСинхронизацииДанных = Пользователи.РолиДоступны("НастройкаСинхронизацииДанных");
...
"Необходимо установить полученное обновление, после чего синхронизация будет продолжена.';uk='Отримано оновлення програми з Інтернету."
"Необхідно встановити отримане оновлення, після чого синхронізація буде продовжена.'");
	Иначе
		Элементы.ПоясняющаяНадписьПолученоОбновление.Заголовок = НСтр("ru='Получено обновление программы из Интернета."
"Обратитесь к администратору информационной базы для установки полученного обновления.';uk='Отримано оновлення програми з Інтернету."
