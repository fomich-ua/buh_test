...
"""%1""?';uk='Для виконання дії потрібно записати зміни файлу."
...
"""%1""?';uk='Зняти помітку вилучення з файлу"
"""%1""?'");
		Иначе
			ТекстВопроса = НСтр("ru='Пометить на удаление файл"
"""%1""?';uk='Відмітити для вилучення файл"
"""%1""?'");
		КонецЕсли;
	КонецЕсли;
	...
	Исключение
		Если ТранзакцияАктивна Тогда
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru='Файлы.Ошибка записи присоединенного файла';uk='Файли.Помилка запису приєднаного файлу'",
