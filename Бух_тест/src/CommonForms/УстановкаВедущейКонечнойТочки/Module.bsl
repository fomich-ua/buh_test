...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Установка ведущей конечной точки для ""%1""';uk='Установка провідною кінцевої точки для ""%1""'"),
...
"Перейти в журнал регистрации?';uk='При установці провідною кінцевої точки виникли помилки."
