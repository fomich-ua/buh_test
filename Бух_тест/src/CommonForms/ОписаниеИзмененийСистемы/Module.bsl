...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ru='Что нового в конфигурации %1';uk='Що нового в конфігурації %1'");
	...
	Если Не КлиентСервернаяБаза
		...
		ВыполненоОтключениеРегламентныхЗаданий = Найти(ПараметрЗапускаКлиента, "РегламентныеЗаданияОтключены") <> 0;
...
&НаКлиенте
Процедура ОтключеныРегламентныеЗаданияОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылка, СтандартнаяОбработка)
