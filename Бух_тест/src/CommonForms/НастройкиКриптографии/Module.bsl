...
"расширение работы с криптографией.';uk='Для настройки ЕП необхідно встановити"
"розширення роботи із криптографією.'");
...
"Укажите Провайдера и его Тип согласно инструкции фирмы-производителя криптопровайдера.';uk='Не вдалося підключити провайдера ЕП."
"Вкажіть Провайдера та його Тип згідно інструкції фірми-виробника криптопровайдера.'"),
			,
			"ТипПровайдераЭП");
	КонецЕсли;
...
Процедура ПровайдерЭПОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	Если ВыбранноеЗначение = ">>" Тогда
		...
		ПоказатьВводСтроки(Обработчик, ПровайдерЭП, НСтр("ru='Имя провайдера электронной подписи';uk=""Ім'я провайдера електронного підпису"""));
	Иначе
		...
		Разрешения.Добавить( 
			РаботаВБезопасномРежиме.РазрешениеНаИспользованиеКаталогаФайловойСистемы(Файл.Путь, Истина, Ложь,
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Доступ к внешнему модулю криптографии на компьютере (%1)';uk=""Доступ до зовнішнього модуля криптографії на комп'ютері (%1)"""), СтрокаПути.ИмяКомпьютера
		)));
...
Процедура ДействияПриОткрытии()
	...
	Элементы.ПровайдерЭП.СписокВыбора.Добавить(">>", НСтр("ru='Ввести вручную';uk='Ввести вручну'"));
...
"Укажите Провайдера и его Тип согласно инструкции фирмы-производителя криптопровайдера.';uk='Не вдалося підключити провайдера ЕП: %1"
"Укажіть Провайдера і його Тип відповідно до інструкції фірми-виробника криптопровайдера.'"),
					ПредставлениеОшибки
				),
				,
				"ТипПровайдераЭП");
