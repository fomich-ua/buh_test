...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ПравоДоступа("СохранениеДанныхПользователя", Метаданные) Тогда
		ТекстОшибки = НСтр("ru='Отсутствует право сохранения данных. Обратитесь к администратору.';uk='Відсутнє право збереження даних. Зверніться до адміністратора.'"); // Отказ устанавливается в ПриОткрытии.
		Возврат;
	КонецЕсли;
...
Процедура ЛичныйСертификатНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Иначе
		...
		ТекстВопроса = НСтр("ru='Для выбора сертификата необходимо установить расширение работы с криптографией.';uk='Для вибору сертифікату необхідно встановити розширення роботи з криптографією.'");
