...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если СтандартныеПодсистемыВызовСервера.ПараметрыРаботыКлиента().ИнформационнаяБазаФайловая Тогда
		Элементы.ПутьКАрхивуWindows.Заголовок = НСтр("ru='Для сервера 1С:Предприятия под управлением Microsoft Windows';uk='Для сервера 1С:Підприємства під управлінням Microsoft Windows'"); 
	Иначе
...
"файлами начального образа (файл *.zip)';uk=""Вкажіть повне ім'я архіву"
...
"должен быть в формате UNC (\\servername\resource).';uk='Шлях до архіву з файлами початкового образу"
...
"архива с файлами начального образа...';uk='Здійснюється розміщення файлів з"
...
"начального образа успешно завершено.';uk='Розміщення файлів з архіву з файлами"
