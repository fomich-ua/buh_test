...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Пользователи.ЭтоПолноправныйПользователь() Тогда
		...
		ВызватьИсключение НСтр("ru='Недостаточно прав для настройки автономной работы.';uk='Недостатньо прав для настройки автономної роботи.'");
		
	ИначеЕсли Не АвтономнаяРаботаСлужебный.АвтономнаяРаботаПоддерживается() Тогда
		
		ВызватьИсключение НСтр("ru='Возможность автономной работы в программе не предусмотрена.';uk='Можливість автономної роботи в програмі не передбачена.'");
...
Процедура КакУстановитьИлиОбновитьВерсиюПлатформы1СПредприятие(Команда)
	...
	ПараметрыФормы.Вставить("Заголовок", НСтр("ru='Как установить или обновить версию платформы 1С:Предприятие';uk='Як встановити або оновити версію платформи 1С:Підприємство'"));
...
Процедура КакНастроитьАвтономноеРабочееМесто(Команда)
	...
	ПараметрыФормы.Вставить("Заголовок", НСтр("ru='Как настроить автономное рабочее место';uk='Як настроїти автономне робоче місце'"));
