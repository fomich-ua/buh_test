...
""
"Данные будут записаны.';uk='Очистити уведені вагові коефіцієнти?"
""
...
""
"Данные будут записаны.';uk='Перехід до роботи зі списком значень"
...
""
"Удаленный тип восстановлен.';uk='Неприпустимо вилучити тип ""%1"","
...
"""%2""."
""
"Второй тип удален.';uk='Неприпустимо одночасно використовувати типи значення"
"""%1"" й"
"""%2""."
""
...
"""%2""."
""
"Первый тип удален.';uk='Неприпустимо одночасно використовувати типи значення"
"""%1"" й"
"""%2""."
""
	...
	Иначе
		...
		Если СписокНаборов.Количество() > 0 Тогда
			...
			Иначе
				...
				Иначе
					Если Объект.ЭтоДополнительноеСведение Тогда
						ШаблонУточнения = НСтр("ru='Общее сведение входит в набор: %1';uk='Загальна відомість входить у набір: %1'");
					Иначе
...
"иначе программа может работать некорректно.';uk='"
""
"Рекомендується використовувати інше найменування,"
