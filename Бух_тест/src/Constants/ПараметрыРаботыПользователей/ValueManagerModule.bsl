...
Функция НедоступныеПраваПоТипамПользователей()
	...
	Права.Вставить("Администрирование",       НСтр("ru='Администрирование';uk='Адміністрування'"));
	Права.Вставить("АдминистрированиеДанных", НСтр("ru='Администрирование данных';uk='Адміністрування даних'"));
	
	Права = Новый Соответствие;
	НедоступныеПрава.Вставить(Перечисления.ТипыПользователей.ПользовательЛокальногоРешения, Права);
	Права.Вставить("Администрирование",                     НСтр("ru='Администрирование';uk='Адміністрування'"));
	Права.Вставить("ОбновлениеКонфигурацииБазыДанных",      НСтр("ru='Обновление конфигурации базы данных';uk='Оновлення конфігурації бази даних'"));
	
	Права = Новый Соответствие;
	НедоступныеПрава.Вставить(Перечисления.ТипыПользователей.ПользовательОбластиДанных, Права);
	Права.Вставить("Администрирование",                     НСтр("ru='Администрирование';uk='Адміністрування'"));
	Права.Вставить("ОбновлениеКонфигурацииБазыДанных",      НСтр("ru='Обновление конфигурации базы данных';uk='Оновлення конфігурації бази даних'"));
	Права.Вставить("ТолстыйКлиент",                         НСтр("ru='Толстый клиент';uk='Товстий клієнт'"));
	Права.Вставить("ВнешнееСоединение",                     НСтр("ru='Внешнее соединение';uk=""Зовнішнє з'єднання"""));
	Права.Вставить("Automation",                            НСтр("ru='Automation';uk='Automation'"));
	Права.Вставить("ИнтерактивноеОткрытиеВнешнихОбработок", НСтр("ru='Интерактивное открытие внешних обработок';uk='Інтерактивне відкриття зовнішніх обробок'"));
	Права.Вставить("ИнтерактивноеОткрытиеВнешнихОтчетов",   НСтр("ru='Интерактивное открытие внешних отчетов';uk='Інтерактивне відкриття зовнішніх звітів'"));
	Права.Вставить("РежимВсеФункции",                       НСтр("ru='Режим все функции';uk='Режим всі функції'"));
