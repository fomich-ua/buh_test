...
"сгруппированные по разделам с объектами.';uk=""Виводить дати заборони зміни для користувачів,"
"згруповані за розділами з об'єктами.""");
	...
	ИначеЕсли Свойства.ВсеРазделыБезОбъектов Тогда
		...
		ОписаниеВарианта =
			НСтр("ru='Выводит даты запрета изменения для пользователей,"
"сгруппированные по разделам.';uk='Виводить дати заборони зміни для користувачів,"
"згруповані по розділах.'");
	Иначе
		ИмяВарианта = "ДатыЗапретаИзмененияПоОбъектамДляПользователей";
		ОписаниеВарианта =
			НСтр("ru='Выводит даты запрета изменения для пользователей,"
"сгруппированные по объектам.';uk=""Виводить дати заборони зміни для користувачів,"
...
"сгруппированные по пользователям.';uk=""Виводить дати заборони зміни для розділів з об'єктами,"
...
"сгруппированные по пользователям.';uk='Виводить дати заборони зміни для розділів,"
"згруповані за користувачами.'");
	Иначе
		ИмяВарианта = "ДатыЗапретаИзмененияПоПользователямБезРазделов";
		ОписаниеВарианта =
			НСтр("ru='Выводит даты запрета изменения для объектов,"
"сгруппированные по пользователям.';uk=""Виводить дати заборони зміни для об'єктів,"
"згруповані за користувачами.""");
	КонецЕсли;
	НастройкиВарианта = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, ИмяВарианта);
	НастройкиВарианта.Включен  = Истина;
