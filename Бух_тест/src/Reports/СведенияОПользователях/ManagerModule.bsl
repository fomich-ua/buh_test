...
"включая настройки для входа (если указаны).';uk='Виводить докладні відомості про всіх користувачів,"
...
"включая настройки для входа (если указаны).';uk='Виводить докладні відомості про користувачів,"
"включаючи настройки для входу (якщо зазначені).'");
...
"включая настройки для входа (если указаны).';uk='Виводить докладні відомості про зовнішніх користувачів,"
"включаючи настройки для входу (якщо зазначені).'");
	НастройкиВарианта.ФункциональныеОпции.Добавить("ИспользоватьВнешнихПользователей");
КонецПроцедуры
