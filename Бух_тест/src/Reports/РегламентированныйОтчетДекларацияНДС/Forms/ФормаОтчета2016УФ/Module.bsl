	...
	Если ТипЗнч(ПараметрыЗаполненияЗвит1С) = Тип("Структура") Тогда
		...
		Исключение
			...
			Если глМенеджерЗвит1С.ФлагОтладки Тогда
				Сообщить("1С:Звіт. Исключение при получении данных из 1С:Звіт ("+ПараметрыЗаполненияЗвит1С.ПараметрыЗапроса.ИмяСхемы1+", "+ПараметрыЗаполненияЗвит1С.ПараметрыЗапроса.ТипПериода+", "+ПараметрыЗаполненияЗвит1С.ПараметрыЗапроса.НомерПериода+", " +ПараметрыЗаполненияЗвит1С.ПараметрыЗапроса.ГодПериода+")", СтатусСообщения.Важное);
		...
		Исключение
			...
			Если глМенеджерЗвит1С.ФлагОтладки Тогда
				Сообщить("1С:Звіт. Исключение при получении данных из 1С:Звіт ("+ПараметрыЗаполненияЗвит1С.ПараметрыЗапроса.ИмяСхемы3+", "+ПараметрыЗаполненияЗвит1С.ПараметрыЗапроса.ТипПериода+", "+ПараметрыЗаполненияЗвит1С.ПараметрыЗапроса.НомерПериода+", " +ПараметрыЗаполненияЗвит1С.ПараметрыЗапроса.ГодПериода+")", СтатусСообщения.Важное);
				Сообщить(ОписаниеОшибки(), СтатусСообщения.Информация);
			КонецЕсли;
