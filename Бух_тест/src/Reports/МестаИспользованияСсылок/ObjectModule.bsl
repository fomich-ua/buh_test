...
Функция ЗаголовокПоНаборуСсылок(Знач НаборСсылок)
	...
	Если ТипЗнч(НаборСсылок) = Тип("СписокЗначений") Тогда
		...
		Если ВсегоСсылок >= 0 Тогда
			...
			Если ОдинаковыйТип Тогда
				Результат = СтрЗаменить(НСтр("ru='Места использования %1';uk='Місця використання %1'"), "%1", 
	...
	Если Результат = Неопределено Тогда
		Результат = НСтр("ru='Места использования элементов';uk='Місця використання елементів'");
	КонецЕсли;
