...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	Если Не НаименованиеТекущегоВарианта = НСтр("ru='Продолжительность работы регламентных заданий';uk='Тривалість роботи регламентних завдань'") Тогда
...
Функция СформироватьОтчетСервер(ПараметрыОтчета)
	...
	Иначе
		РезультатВыполнения = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			...
			ПараметрыОтчета, 
			НСтр("ru='Выполнение отчета: Анализ журнала регистрации';uk='Виконання звіту: Аналіз журналу реєстрації'"));
